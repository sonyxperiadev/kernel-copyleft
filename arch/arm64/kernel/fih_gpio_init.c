...
{
  { 50, FIH_CFG(0, FIH_INPUT, FIH_PULL_UP,   FIH_2MA), FIH_ENABLE},  //S1_SOFT_SERVICE
...
{
  { 12, FIH_CFG(0, FIH_OUTPUT,FIH_PULL_UP,   FIH_2MA), FIH_ENABLE_HIGH}, //TP_RESET_N
  { 16, FIH_CFG(0, FIH_INPUT, FIH_PULL_DOWN, FIH_2MA), FIH_ENABLE},
  { 37, FIH_CFG(2, FIH_OUTPUT,FIH_NO_PULL,   FIH_2MA), FIH_ENABLE_LOW}, //EDL
  { 52, FIH_CFG(0, FIH_INPUT, FIH_NO_PULL,   FIH_2MA), FIH_ENABLE}, //TP_ID
  { -1, FIH_CFG(0, 0, 0, 0), -1}
};
...
/*
  the numbers stand for GPIO settings after patching
...
static FIH_GPIO_MAP TUL_RITA_MAP[]=
{
  ...
  {PHASE_PD1, SIM_SINGLE, TUL_RITA_PD1}, //50,74,75,76,77,78,79,80,81,83,86,88,89,92,94,100,101,102,105,106,112,115,117,118,119
  {PHASE_PD2, SIM_SINGLE, FAKE_TEMP},    //same as TUL_RITA_PD1
  {PHASE_PD3, SIM_SINGLE, TUL_ALL_PD3},  //50,74,75,76,77,78,79,80,81,83,86,88,89,90,92,94,100,101,102,105,106,112,115,117,118,119
  {PHASE_DP,  SIM_SINGLE, TUL_ALL_DP},   //16,37,50,74,75,76,77,78,79,80,81,83,86,88 89,90,92,94,100,101,102,105,106,112,115,117,118,119
  //------------------------------------------------------------
  {PHASE_PD1, SIM_DUAL,   TUL_ALL_PD1},  //50,74,75,76,77,78,79,80,81,83,86,88,89,92,94,100,101,102,105,106,112,115,117,118,119
  {PHASE_PD2, SIM_DUAL,   FAKE_TEMP},    //same as TUL_ALL_PD1
  {PHASE_PD3, SIM_DUAL,   TUL_ALL_PD3},  //50,74,75,76,77,78,79,80,81,83,86,88,89,90,92,94,100,101,102,105,106,112,115,117,118,119
  {PHASE_DP,  SIM_DUAL,   TUL_ALL_DP},   //16,37,50,74,75,76,77,78,79,80,81,83,86,88 89,90,92,94,100,101,102,105,106,112,115,117,118,119
  {PHASE_MAX, SIM_MAX,    FAKE_TEMP}
};
//=======================================================
static FIH_GPIO_MAP TUL_GINA_MAP[]=
{
  {PHASE_PD1, SIM_SINGLE, TUL_ALL_PD1},  //50,74,75,76,77,78,79,80,81,83,86,88,89,92,94,100,101,102,105,106,112,115,117,118,119
...
static FIH_GPIO_MAP TUL_REX_MAP[]=
{
  ...
  {PHASE_DP,   SIM_SINGLE, TUL_ALL_DP},   //16,37,50,74,75,76,77,78,79,80,81,83,86,88 89,90,92,94,100,101,102,105,106,112,115,117,118,119
  //------------------------------------------------------------
  {PHASE_EVM2, SIM_DUAL,   TUL_REX_EVM2}, //50,74,75,76,77,78,79,80,81,83,86,88,89,90,92,94,100,101,102,105,106
  {PHASE_PD3,  SIM_DUAL,   TUL_REX_PD3},  //50,74,75,76,77,78,79,80,81,83,86,88,89,90,92,94,100,101,102,105,106,112,115,117,118,119
  {PHASE_DP,   SIM_DUAL,   TUL_ALL_DP},   //16,37,50,74,75,76,77,78,79,80,81,83,86,88 89,90,92,94,100,101,102,105,106,112,115,117,118,119
  {PHASE_MAX,  SIM_MAX,    FAKE_TEMP}
};
//=======================================================
...
{
  { 16, FIH_CFG(0, FIH_INPUT, FIH_PULL_DOWN, FIH_2MA), FIH_ENABLE},
  { 52, FIH_CFG(1, FIH_INPUT, FIH_PULL_UP,   FIH_2MA), FIH_ENABLE},
  { 82, FIH_CFG(0, FIH_INPUT, FIH_PULL_DOWN, FIH_2MA), FIH_ENABLE},
  { 87, FIH_CFG(0, FIH_INPUT, FIH_PULL_DOWN, FIH_2MA), FIH_ENABLE},
...
static FIH_GPIO_MAP TUL_VIV_MAP[]=
{
  {PHASE_PD1, SIM_SINGLE, TUL_ALL_PD1},  //50,74,75,76,77,78,79,80,81,83,86,88,89,92,94,100,101,102,105,106,112,115,117,118,119
  {PHASE_PD2, SIM_SINGLE, FAKE_TEMP},    //same as TUL_ALL_PD1
  {PHASE_PD3, SIM_SINGLE, TUL_VIV_PD3},  //37,49,50,74,75,76,77,78,79,80,81,83,86,88,89,92,94,100,101,102,105,106
  {PHASE_DP,  SIM_SINGLE, TUL_VIV_DP},   //16,37,49,50,74,75,76,77,78,79,80,81,82,83,86,87,88,89,92,94,100,101,102,105,106,116
  {PHASE_MAX, SIM_MAX,    FAKE_TEMP}
};
//=======================================================
...
static void fih_config_gpio_table(void)
{
  ...
  for(i=0; i<122; i++)
  {
    ...
    else if(main_table[i].enable==FIH_ENABLE_HIGH)
    {
      fih_gp_cfg(main_table[i].pin, main_table[i].config);
      fih_gp_out_set(main_table[i].pin,1);
    }
    else if(main_table[i].enable==FIH_ENABLE_LOW)
    {
      fih_gp_cfg(main_table[i].pin, main_table[i].config);
      fih_gp_out_set(main_table[i].pin,0);
    }
  }
};
