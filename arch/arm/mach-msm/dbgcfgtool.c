...
unsigned int debug_force_trigger_panic_enable = 0;  /* Enable by default temporarily */
unsigned int debug_cpu_usage_enable = 0;
unsigned int debug_tcxo_sd_during_display_on = 0;
unsigned int debug_ramdump_to_sdcard_enable = 0;  /*CORE-HC-RAMDUMP-00+*/
...
early_param("oemandroidboot.babe1234", debug_cmdline_parameter_parser);
