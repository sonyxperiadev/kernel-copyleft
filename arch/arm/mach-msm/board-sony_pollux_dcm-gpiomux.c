...
static struct gpiomux_setting ir_uart = {
	.func = GPIOMUX_FUNC_1,
	.drv  = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_NONE,
};
...
static struct msm_gpiomux_config fusion_all_configs[] __initdata = {
	...
	{ /* NC(Reserved FELICA_UART_TX) */
		.gpio = 82,
		.settings = { [GPIOMUX_SUSPENDED] = &unused_gpio, },
	},
	{ /* NC(Reserved FELICA_UART_RX) */
		.gpio = 83,
		.settings = { [GPIOMUX_SUSPENDED] = &unused_gpio, },
	},
	{ /* NC(AP2MDM_IPC3) */
...
static void __init gpiomux_arrange_all_qct_configs(void)
{
	...
	if (machine_is_apq8064_mtp() || machine_is_sony_pollux_dcm())
