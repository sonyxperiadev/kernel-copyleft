...
#if defined(CONFIG_MACH_SONY_YUGA_DCM)
...
static struct platform_device apq8064_device_ext_sd_pwr_vreg __devinitdata = {
	.name   = GPIO_REGULATOR_DEV_NAME,
	.id     = PM8921_MPP_PM_TO_SYS(4),
	.dev    = {
		.platform_data =
		&apq8064_gpio_regulator_pdata[GPIO_VREG_ID_EXT_SD_PWR],
	},
};
...
static struct platform_device *common_devices[] __initdata = {
	...
	&apq8064_device_ext_sd_pwr_vreg,
