...
static struct msm_gpiomux_config rhine_all_configs[] __initdata = {
	...
	{ /* NC(GRFC9(PA0_R1/ET_CAL_SEL1)) (BOOT_CONFIG[1]) */
		.gpio = 113,
		.settings = { [GPIOMUX_SUSPENDED] = &unused_gpio, },
	},
	{ /* NC(DRX_SW_SEL0) [BOOT_CONFIG_2] */
		.gpio = 114,
		.settings = { [GPIOMUX_SUSPENDED] = &unused_gpio, },
	},
	...
	{ /* NC(PRX_SW_SEL1) [APPS_BOOT_FROM_ROM] */
		.gpio = 118,
		.settings = { [GPIOMUX_SUSPENDED] = &unused_gpio, },
	},
	...
	{ /* NC(GRFC16(1X_MRD_SEL/BCX_SW_SEL0)) [APPS_PBL_BOOT_SPEED0] */
		.gpio = 120,
		.settings = { [GPIOMUX_SUSPENDED] = &unused_gpio, },
	},
	{ /* NC(GRFC17(PRX_SW_SEL0/RF_SW_SEL4)) [APPS_PBL_BOOT_SPEED1] */
		.gpio = 121,
		.settings = { [GPIOMUX_SUSPENDED] = &unused_gpio, },
	},
	...
	{ /* NC(WTR0_SSBI1_TX_GPS) */
		.gpio = 133,
		.settings = { [GPIOMUX_SUSPENDED] = &unused_gpio, },
	},
	{ /* NC(WTR0_SSBI2_PRX_DRX) */
		.gpio = 134,
		.settings = { [GPIOMUX_SUSPENDED] = &unused_gpio, },
	},
	{ /* WTR1_SSBI1_TX_GPS */
