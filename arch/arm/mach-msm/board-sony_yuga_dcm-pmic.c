...
static struct pm8xxx_gpio_init pm8921_gpios[] __initdata = {
	...
	PM8921_GPIO_INPUT(21, PM_GPIO_PULL_DN),    /* FELICA_RFS */
	...
	PM8921_GPIO_OUTPUT(30, 0, LOW),            /* NFC_EXT_LDO_EN */
	/* FELICA_LOCK */
	...
	/* GPIO_35 is set in pm8921_*_gpios */
...
static struct pm8xxx_gpio_init pm8921_sp1_gpios[] __initdata = {
	PM8921_GPIO_DISABLE(35),                   /* NC */
};

static struct pm8xxx_gpio_init pm8921_sp11_gpios[] __initdata = {
	/* KOTO_PWR_EN */
	PM8921_GPIO_INIT(35, PM_GPIO_DIR_OUT, PM_GPIO_OUT_BUF_CMOS, 1, \
			PM_GPIO_PULL_NO, PM_GPIO_VIN_VPH, \
