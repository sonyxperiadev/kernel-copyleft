...
static struct gpiomux_setting ap2mdm_kpdpwr_n_2ma_cfg = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_DOWN,
};
...
static struct msm_gpiomux_config sglte_configs[] __initdata = {
	...
	/* AP2MDM_PMIC_PWR_EN */
	{
		.gpio = 22,
		.settings = {
			[GPIOMUX_SUSPENDED] = &ap2mdm_kpdpwr_n_2ma_cfg,
		}
	},
	/* AP2MDM_SOFT_RESET */
	{
...
static struct msm_gpiomux_config semc_viskan_all_cfgs[] __initdata = {
	...
	/* 71: UIM2_DATA_MSM (Follow QCT) */
	/* 72: UIM2_CLK_MSM (Follow QCT) */
	/* 73: I2C_DATA_PERI */
	/* 74: I2C_CLK_PERI */
	{ /* NC */
		.gpio = 75,
	...
	/* 79: AP2MDM_KPDPWR_N (Follow QCT), is IPC handshaking signals. */
	/* 80: AP2MDM_ERRFATAL (Follow QCT), is IPC handshaking signals. */
	/* 81: MDM2AP_WAKE_UP (Follow QCT), is IPC handshaking signals. */
	/* 82: AP2MDM_WAKE_UP (Follow QCT), is IPC handshaking signals. */
	...
	{ /* NC, Reserved for RF_ID_EXTENSION, not connected */
		.gpio = 98,
		.settings = {
			[GPIOMUX_SUSPENDED] = &gpio_2ma_no_pull_low,
		},
