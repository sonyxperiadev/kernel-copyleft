...
static struct acpu_level freq_tbl_PVS0[] __initdata = {
	...
	{ 1, {   810000, HFPLL, 1, 0x1E }, L2(4),  1025000 + VOLTAGE_TUNE, AVS(0x0) },
	{ 1, {   918000, HFPLL, 1, 0x22 }, L2(4),  1050000 + VOLTAGE_TUNE, AVS(0x0) },
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(4),  1075000 + VOLTAGE_TUNE, AVS(0x0) },
	{ 1, {  1134000, HFPLL, 1, 0x2A }, L2(9),  1100000 + VOLTAGE_TUNE, AVS(0x70000D) },
	{ 1, {  1242000, HFPLL, 1, 0x2E }, L2(9),  1125000 + VOLTAGE_TUNE, AVS(0x0) },
	{ 1, {  1350000, HFPLL, 1, 0x32 }, L2(9),  1150000 + VOLTAGE_TUNE, AVS(0x0) },
	{ 1, {  1458000, HFPLL, 1, 0x36 }, L2(9),  1175000 + VOLTAGE_TUNE, AVS(0x0) },
	{ 1, {  1566000, HFPLL, 1, 0x3A }, L2(9),  1200000 + VOLTAGE_TUNE, AVS(0x0) },
...
static struct acpu_level freq_tbl_PVS1[] __initdata = {
	...
	{ 1, {   702000, HFPLL, 1, 0x1A }, L2(4),   975000 + VOLTAGE_TUNE, AVS(0x0) },
	{ 1, {   810000, HFPLL, 1, 0x1E }, L2(4),  1000000 + VOLTAGE_TUNE, AVS(0x0) },
	{ 1, {   918000, HFPLL, 1, 0x22 }, L2(4),  1025000 + VOLTAGE_TUNE, AVS(0x0) },
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(4),  1050000 + VOLTAGE_TUNE, AVS(0x0) },
	{ 1, {  1134000, HFPLL, 1, 0x2A }, L2(9),  1075000 + VOLTAGE_TUNE, AVS(0x70000D) },
	{ 1, {  1242000, HFPLL, 1, 0x2E }, L2(9),  1100000 + VOLTAGE_TUNE, AVS(0x0) },
	{ 1, {  1350000, HFPLL, 1, 0x32 }, L2(9),  1125000 + VOLTAGE_TUNE, AVS(0x0) },
	{ 1, {  1458000, HFPLL, 1, 0x36 }, L2(9),  1150000 + VOLTAGE_TUNE, AVS(0x0) },
	{ 1, {  1566000, HFPLL, 1, 0x3A }, L2(9),  1175000 + VOLTAGE_TUNE, AVS(0x0) },
...
static struct acpu_level freq_tbl_PVS2[] __initdata = {
	...
	{ 1, {   702000, HFPLL, 1, 0x1A }, L2(4),   950000 + VOLTAGE_TUNE, AVS(0x0) },
	{ 1, {   810000, HFPLL, 1, 0x1E }, L2(4),   975000 + VOLTAGE_TUNE, AVS(0x0) },
	{ 1, {   918000, HFPLL, 1, 0x22 }, L2(4),  1000000 + VOLTAGE_TUNE, AVS(0x0) },
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(4),  1025000 + VOLTAGE_TUNE, AVS(0x0) },
	{ 1, {  1134000, HFPLL, 1, 0x2A }, L2(9),  1050000 + VOLTAGE_TUNE, AVS(0x70000D) },
	{ 1, {  1242000, HFPLL, 1, 0x2E }, L2(9),  1075000 + VOLTAGE_TUNE, AVS(0x0) },
	{ 1, {  1350000, HFPLL, 1, 0x32 }, L2(9),  1100000 + VOLTAGE_TUNE, AVS(0x0) },
	{ 1, {  1458000, HFPLL, 1, 0x36 }, L2(9),  1125000 + VOLTAGE_TUNE, AVS(0x0) },
	{ 1, {  1566000, HFPLL, 1, 0x3A }, L2(9),  1150000 + VOLTAGE_TUNE, AVS(0x0) },
...
static struct acpu_level freq_tbl_PVS3[] __initdata = {
	...
	{ 1, {   702000, HFPLL, 1, 0x1A }, L2(4),   925000 + VOLTAGE_TUNE, AVS(0x0) },
	{ 1, {   810000, HFPLL, 1, 0x1E }, L2(4),   950000 + VOLTAGE_TUNE, AVS(0x0) },
	{ 1, {   918000, HFPLL, 1, 0x22 }, L2(4),   975000 + VOLTAGE_TUNE, AVS(0x0) },
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(4),  1000000 + VOLTAGE_TUNE, AVS(0x0) },
	{ 1, {  1134000, HFPLL, 1, 0x2A }, L2(9),  1025000 + VOLTAGE_TUNE, AVS(0x70000D) },
	{ 1, {  1242000, HFPLL, 1, 0x2E }, L2(9),  1050000 + VOLTAGE_TUNE, AVS(0x0) },
	{ 1, {  1350000, HFPLL, 1, 0x32 }, L2(9),  1075000 + VOLTAGE_TUNE, AVS(0x0) },
	{ 1, {  1458000, HFPLL, 1, 0x36 }, L2(9),  1100000 + VOLTAGE_TUNE, AVS(0x0) },
	{ 1, {  1566000, HFPLL, 1, 0x3A }, L2(9),  1125000 + VOLTAGE_TUNE, AVS(0x0) },
...
static struct acpu_level freq_tbl_PVS4[] __initdata = {
	...
	{ 1, {   702000, HFPLL, 1, 0x1A }, L2(4),   900000 + VOLTAGE_TUNE, AVS(0x0) },
	{ 1, {   810000, HFPLL, 1, 0x1E }, L2(4),   925000 + VOLTAGE_TUNE, AVS(0x0) },
	{ 1, {   918000, HFPLL, 1, 0x22 }, L2(4),   950000 + VOLTAGE_TUNE, AVS(0x0) },
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(4),   975000 + VOLTAGE_TUNE, AVS(0x0) },
	{ 1, {  1134000, HFPLL, 1, 0x2A }, L2(9),  1000000 + VOLTAGE_TUNE, AVS(0x70000D) },
	{ 1, {  1242000, HFPLL, 1, 0x2E }, L2(9),  1025000 + VOLTAGE_TUNE, AVS(0x0) },
	{ 1, {  1350000, HFPLL, 1, 0x32 }, L2(9),  1050000 + VOLTAGE_TUNE, AVS(0x0) },
	{ 1, {  1458000, HFPLL, 1, 0x36 }, L2(9),  1075000 + VOLTAGE_TUNE, AVS(0x0) },
	{ 1, {  1566000, HFPLL, 1, 0x3A }, L2(9),  1100000 + VOLTAGE_TUNE, AVS(0x0) },
...
static struct acpu_level freq_tbl_PVS5[] __initdata = {
	...
	{ 1, {   486000, HFPLL, 2, 0x24 }, L2(4),   875000 + VOLTAGE_TUNE, AVS(0x0) },
	{ 1, {   594000, HFPLL, 1, 0x16 }, L2(4),   875000 + VOLTAGE_TUNE, AVS(0x0) },
	{ 1, {   702000, HFPLL, 1, 0x1A }, L2(4),   875000 + VOLTAGE_TUNE, AVS(0x0) },
	{ 1, {   810000, HFPLL, 1, 0x1E }, L2(4),   900000 + VOLTAGE_TUNE, AVS(0x0) },
	{ 1, {   918000, HFPLL, 1, 0x22 }, L2(4),   925000 + VOLTAGE_TUNE, AVS(0x0) },
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(4),   950000 + VOLTAGE_TUNE, AVS(0x0) },
	{ 1, {  1134000, HFPLL, 1, 0x2A }, L2(9),   975000 + VOLTAGE_TUNE, AVS(0x70000D) },
	{ 1, {  1242000, HFPLL, 1, 0x2E }, L2(9),  1000000 + VOLTAGE_TUNE, AVS(0x0) },
	{ 1, {  1350000, HFPLL, 1, 0x32 }, L2(9),  1025000 + VOLTAGE_TUNE, AVS(0x0) },
	{ 1, {  1458000, HFPLL, 1, 0x36 }, L2(9),  1050000 + VOLTAGE_TUNE, AVS(0x0) },
	{ 1, {  1566000, HFPLL, 1, 0x3A }, L2(9),  1075000 + VOLTAGE_TUNE, AVS(0x0) },
