...
#	dtb-$(CONFIG_ARCH_MSM8226)	+= apq8026-v2-1080p-cdp.dtb
        ...
        dtb-$(CONFIG_MACH_SONY_TIANCHI) += msm8926-v1-yukon_tianchi.dtb
        dtb-$(CONFIG_MACH_SONY_TIANCHI) += msm8926-v2-yukon_tianchi.dtb
        dtb-$(CONFIG_MACH_SONY_WUKONG) += msm8926-v1-yukon_wukong.dtb
        dtb-$(CONFIG_MACH_SONY_WUKONG) += msm8926-v2-yukon_wukong.dtb
