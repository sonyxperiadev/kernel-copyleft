...
static struct gpiomux_setting gpio_2ma_no_pull_low_inv = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv  = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_NONE,
	.dir  = GPIOMUX_OUT_LOW,
...
static struct msm_gpiomux_config bl_config __initdata = {
	...
	.gpio = 27,
	.settings = {
		[GPIOMUX_ACTIVE] = &gpio_2ma_no_pull_low_inv,
		[GPIOMUX_SUSPENDED] = &gpio_2ma_no_pull_low,
	},
};

static struct msm_gpiomux_config sony_wukong_all_cfgs[] __initdata = {
	{  /* DEBUG_GPIO0 */
		.gpio = 0,
		.settings = {
	...
	/* 36: CHATCAM_POWER_DOWN (msm_sensor_configs) */
	/* 37: CAM1_RST_N (msm_sensor_configs) */
	...
	/* 90: GRFC15 (Follow QCT) */
	/* 91: GRFC16 (Follow QCT) */
...
{
	msm_gpiomux_install(sony_wukong_all_cfgs,
			ARRAY_SIZE(sony_wukong_all_cfgs));
