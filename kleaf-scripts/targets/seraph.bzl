...
def define_seraph():
    ...
    define_typical_android_build(
        name = "seraph",
        consolidate_config = seraph_consolidate_config,
        perf_config = seraph_perf_config,
        consolidate_build_img_opts = consolidate_build_img_opts,
        perf_build_img_opts = perf_build_img_opts,
        consolidate_kwargs = {
            "config_path": "configs/seraph_consolidate.bzl",
        },
        perf_kwargs = {
            "config_path": "configs/seraph_perf.bzl",
        },
    )

    kernel_abi(
        name = "seraph_perf_abi",
