...
void reset_all_window_stats(u64 window_start, unsigned int window_size)
{
	...
	for_each_possible_cpu(cpu) {
		...
		if (window_start) {
			...
			u32 mostly_occupied_load = rq->mostly_occupied_load; /*CORE-TH-Patch_CurrentConsumption-00+*/
			...
			rq->mostly_occupied_load = div64_u64((u64)mostly_occupied_load *
				(u64)sched_ravg_window, (u64)old_window_size);
			/*CORE-TH-Patch_CurrentConsumption-00-*/
		}
#ifdef CONFIG_SCHED_FREQ_INPUT
...
void __init sched_init(void)
{
	...
	for_each_possible_cpu(i) {
		...
		rq->mostly_occupied_load = pct_to_real(80); /*CORE-TH-Patch_CurrentConsumption-00+*/
