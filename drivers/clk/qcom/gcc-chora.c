...
static struct clk_vdd_class *gcc_chora_regulators[] = {
	&vdd_cx,
	&vdd_mx,
};
...
static struct clk_rcg2 gcc_pcie_0_aux_clk_src = {
	...
	.clkr.vdd_data = {
		.vdd_classes = gcc_chora_regulators,
		.num_vdd_classes = ARRAY_SIZE(gcc_chora_regulators),
		.num_rate_max = VDD_NUM,
		.rate_max = (unsigned long[VDD_NUM]) {
			[VDD_LOWER] = 19200000},
	},
...
static struct clk_branch gcc_aggre_noc_pcie_axi_clone_clk = {
	.halt_reg = 0x10074,
	.halt_check = BRANCH_HALT_SKIP,
	.hwcg_reg = 0x10074,
	.hwcg_bit = 1,
	.clkr = {
		...
		.enable_mask = BIT(24),
		.hw.init = &(const struct clk_init_data) {
			.name = "gcc_aggre_noc_pcie_axi_clone_clk",
			.ops = &clk_branch2_ops,
		},
	},
};
...
static struct clk_branch gcc_cnoc_pcie_sf_axi_clone_clk = {
	.halt_reg = 0x10078,
	.halt_check = BRANCH_HALT_VOTED,
	.hwcg_reg = 0x10078,
	.hwcg_bit = 1,
	.clkr = {
		...
		.enable_mask = BIT(12),
		.hw.init = &(const struct clk_init_data) {
			.name = "gcc_cnoc_pcie_sf_axi_clone_clk",
			.ops = &clk_branch2_ops,
		},
	},
};
...
static struct clk_branch gcc_snoc_cnoc_usb2_clk = {
	.halt_reg = 0x39064,
	.halt_check = BRANCH_HALT_VOTED,
	.hwcg_reg = 0x39064,
	.hwcg_bit = 1,
...
static struct gdsc gcc_usb2_phy_gdsc = {
	.gdscr = 0x5000c,
	.en_rest_wait_val = 0x2,
	.en_few_wait_val = 0x2,
	.clk_dis_wait_val = 0x2,
	.pd = {
		.name = "gcc_usb2_phy_gdsc",
	},
	.pwrsts = PWRSTS_OFF_ON,
	.flags = POLL_CFG_GDSCR | RETAIN_FF_ENABLE,
	.supply = "vdd_mx",
...
static struct clk_regmap *gcc_chora_clocks[] = {
	[GCC_AGGRE_NOC_PCIE_AXI_CLK] = &gcc_aggre_noc_pcie_axi_clk.clkr,
	[GCC_AGGRE_NOC_PCIE_AXI_CLONE_CLK] = &gcc_aggre_noc_pcie_axi_clone_clk.clkr,
	...
	[GCC_CNOC_PCIE_SF_AXI_CLONE_CLK] = &gcc_cnoc_pcie_sf_axi_clone_clk.clkr,
	...
	[GCC_SNOC_CNOC_USB2_CLK] = &gcc_snoc_cnoc_usb2_clk.clkr,
...
static struct gdsc *gcc_chora_gdscs[] = {
	...
	[GCC_USB2_PHY_GDSC] = &gcc_usb2_phy_gdsc,
};

static const struct qcom_reset_map gcc_chora_resets[] = {
	[GCC_CAMERA_BCR] = { 0x26000 },
	[GCC_DISPLAY_BCR] = { 0x27000 },
	[GCC_GPU_BCR] = { 0x71000 },
	[GCC_PCIE_0_BCR] = { 0x6b000 },
	[GCC_PCIE_0_LINK_DOWN_BCR] = { 0x6c114 },
	[GCC_PCIE_0_NOCSR_COM_PHY_BCR] = { 0x6c120 },
	[GCC_PCIE_0_PHY_BCR] = { 0x6c000 },
	[GCC_PCIE_0_PHY_NOCSR_COM_PHY_BCR] = { 0x6c128 },
	...
	[GCC_USB20_BCR] = { 0x39000 },
	[GCC_USB2_DP_PHY_PRIM_BCR] = { 0x50008 },
	[GCC_USB2_PHY_PRIM_BCR] = { 0x50000 },
	[GCC_USB2PHY_PHY_PRIM_BCR] = { 0x50004 },
...
static const struct regmap_config gcc_chora_regmap_config = {
	.reg_bits = 32,
	.reg_stride = 4,
	.val_bits = 32,
...
static const struct qcom_cc_desc gcc_chora_desc = {
	.config = &gcc_chora_regmap_config,
	.clks = gcc_chora_clocks,
	.num_clks = ARRAY_SIZE(gcc_chora_clocks),
	.resets = gcc_chora_resets,
	.num_resets = ARRAY_SIZE(gcc_chora_resets),
	.clk_regulators = gcc_chora_regulators,
	.num_clk_regulators = ARRAY_SIZE(gcc_chora_regulators),
	.gdscs = gcc_chora_gdscs,
	.num_gdscs = ARRAY_SIZE(gcc_chora_gdscs),
};

static const struct of_device_id gcc_chora_match_table[] = {
	{ .compatible = "qcom,chora-gcc" },
	{ }
};
MODULE_DEVICE_TABLE(of, gcc_chora_match_table);

static int gcc_chora_probe(struct platform_device *pdev)
{
	struct regmap *regmap;
	int ret;

	regmap = qcom_cc_map(pdev, &gcc_chora_desc);
	if (IS_ERR(regmap))
...
static void gcc_chora_sync_state(struct device *dev)
{
	qcom_cc_sync_state(dev, &gcc_chora_desc);
}

static struct platform_driver gcc_chora_driver = {
	.probe = gcc_chora_probe,
	.driver = {
		.name = "gcc-chora",
		.of_match_table = gcc_chora_match_table,
		.sync_state = gcc_chora_sync_state,
	},
};

static int __init gcc_chora_init(void)
{
	return platform_driver_register(&gcc_chora_driver);
}
subsys_initcall(gcc_chora_init);

static void __exit gcc_chora_exit(void)
{
	platform_driver_unregister(&gcc_chora_driver);
}
module_exit(gcc_chora_exit);

MODULE_DESCRIPTION("QTI GCC CHORA Driver");
MODULE_LICENSE("GPL");
