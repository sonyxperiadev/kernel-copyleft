...
static irqreturn_t msm_cci_irq(int irq_num, void *data)
{
	...
	if (irq & CCI_IRQ_STATUS_0_RST_DONE_ACK_BMSK) {
		...
		/*
		 * CCI_IRQ_STATUS_0_I2C_M0_RD_UNDERFLOW     -        0x2
		 * CCI_IRQ_STATUS_0_I2C_M0_RD_OVERFLOW      -        0x4
		 * CCI_IRQ_STATUS_0_I2C_M0_Q0_UNDERFLOW     -       0x20
		 * CCI_IRQ_STATUS_0_I2C_M0_Q0_OVERFLOW      -       0x40
		 * CCI_IRQ_STATUS_0_I2C_M0_Q0_CMD_ERR       -       0x80
		 * CCI_IRQ_STATUS_0_I2C_M0_Q1_UNDERFLOW     -      0x200
		 * CCI_IRQ_STATUS_0_I2C_M0_Q1_OVERFLOW      -      0x400
		 * CCI_IRQ_STATUS_0_I2C_M0_Q1_CMD_ERR       -      0x800
		 * CCI_IRQ_STATUS_0_I2C_M0_Q0_NACK_ERR_BMSK -  0x8000000
		 * CCI_IRQ_STATUS_0_I2C_M0_Q1_NACK_ERR_BMSK - 0x10000000
		 */
		...
		/*
		 * CCI_IRQ_STATUS_0_I2C_M1_RD_UNDERFLOW     -     0x2000
		 * CCI_IRQ_STATUS_0_I2C_M1_RD_OVERFLOW      -     0x4000
		 * CCI_IRQ_STATUS_0_I2C_M1_Q0_UNDERFLOW     -    0x20000
		 * CCI_IRQ_STATUS_0_I2C_M1_Q0_OVERFLOW      -    0x40000
		 * CCI_IRQ_STATUS_0_I2C_M1_Q0_CMD_ERR       -    0x80000
		 * CCI_IRQ_STATUS_0_I2C_M1_Q1_UNDERFLOW     -   0x200000
		 * CCI_IRQ_STATUS_0_I2C_M1_Q1_OVERFLOW      -   0x400000
		 * CCI_IRQ_STATUS_0_I2C_M1_Q1_CMD_ERR       -   0x800000
		 * CCI_IRQ_STATUS_0_I2C_M1_Q0_NACK_ERR_BMSK - 0x20000000
		 * CCI_IRQ_STATUS_0_I2C_M1_Q1_NACK_ERR_BMSK - 0x40000000
		 */
