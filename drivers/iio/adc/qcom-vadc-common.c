...
/*
* Voltage to temperature table for QN6832A_1.875v
*/
static const struct vadc_map_pt adcmap_100K_1875_vref_QN6832A[] = {
	{1833 , -40000 },
	{1830 , -39000 },
	{1827 , -38000 },
	{1824 , -37000 },
...
/*add for 235 therml_ntc begin 2*/
static int qcom_vadc_scale_hw_calib_therm_QN6832A(
				const struct vadc_prescale_ratio *prescale,
				const struct adc5_data *data,
				u16 adc_code, int *result_mdec);
/*add for 235 therml_ntc end 2*/
...
static struct qcom_adc5_scale_type scale_adc5_fn[] = {
	...
	[SCALE_HW_CALIB_THERM_100K_PULLUP_QN6832A] = {qcom_vadc_scale_hw_calib_therm_QN6832A},/*add for QN6832A thermal_ntc*/
...
/*add for PDX-235 therml_ntc  begin 1 */
static int qcom_vadc_scale_hw_calib_therm_QN6832A(
				const struct vadc_prescale_ratio *prescale,
				const struct adc5_data *data,
				u16 adc_code, int *result_mdec)
{
	...
	/* Map voltage to temperature from look-up table */
	return qcom_vadc_map_voltage_temp(adcmap_100K_1875_vref_QN6832A,
				 ARRAY_SIZE(adcmap_100K_1875_vref_QN6832A),
				 voltage, result_mdec);
}
/*add for PDX-235 therml_ntc end 1 */
