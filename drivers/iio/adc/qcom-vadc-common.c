...
/*
 * Voltage to temperature table QN6813A 
 * 1.875V reference.
 */
static const struct vadc_map_pt adcmap_100k_1875_vref_QN6813A[] = {
	{1832,-40000 },
	{1829,-39000 },
	{1826,-38000 },
	{1822,-37000 },
...
/*
 * add for sys-therm-3 QN6813A
*/
static const struct vadc_map_pt adcmap_sys_therm_100k_QN6813A[] = {
   {4251000,-40000 },
   {3962000,-39000 },
   {3695000,-38000 },
   {3447000,-37000 },
				...
				u16 adc_code, int *result_mdec)
{
	...
	return qcom_vadc_map_voltage_temp(adcmap_100k_1875_vref_QN6813A,
				 ARRAY_SIZE(adcmap_100k_1875_vref_QN6813A),
				 voltage, result_mdec);
}
				...
				u16 adc_code, int *result_mdec)
{
	...
	ret = qcom_vadc_map_voltage_temp(adcmap_sys_therm_100k_QN6813A,
				 ARRAY_SIZE(adcmap_sys_therm_100k_QN6813A),
				 resistance, &result);
	if (ret)
		return ret;
