...
#if defined(CONFIG_SOMC_CHARGER_EXTENSION)
#define DCIN_IN_COLLAPSE_GF_SEL_MASK		GENMASK(1, 0)
#define DCIN_IN_COLLAPSE_GF_1MS			0
#define DCIN_IN_COLLAPSE_GF_5MS			1
#define DCIN_IN_COLLAPSE_GF_30MS		2
#define DCIN_IN_COLLAPSE_GF_30US		3
#endif
