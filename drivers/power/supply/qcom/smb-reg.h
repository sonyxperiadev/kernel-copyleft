...
#define TCCC_CHARGE_CURRENT_TERMINATION_150MA GENMASK(1,0)
...
#define JEITA_EN_FVC_EN_BIT		BIT(5)
...
#define SCHG_CHGR_CHARGE_SAFETY_TIMER_ENABLE_CFG (CHGR_BASE + 0xA0)
#define CHARGE_SAFETY_TIMER_ENABLE_CFG_MASK GENMASK(1, 0)
#define FAST_CHARGE_SAFETY_TIMER_EN            0
#define PRE_CHARGE_SAFETY_TIMER_EN             1
