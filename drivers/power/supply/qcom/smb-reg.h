...
/* safety timer */
#define SCHG_CHGR_PRE_CHARGE_SAFETY_TIMER_CFG	(CHGR_BASE + 0xA1)
#define PRE_CHARGE_SAFETY_TIMER_CFG_MASK	GENMASK(1, 0)
#define PRE_CHARGE_SAFETY_TIMER_TMOUT_24MIN	0
#define PRE_CHARGE_SAFETY_TIMER_TMOUT_48MIN	1
#define PRE_CHARGE_SAFETY_TIMER_TMOUT_96MIN	2
#define PRE_CHARGE_SAFETY_TIMER_TMOUT_192MIN	3

#define SCHG_CHGR_FAST_CHARGE_SAFETY_TIMER_CFG	(CHGR_BASE + 0xA2)
#define FAST_CHARGE_SAFETY_TIMER_CFG_MASK	GENMASK(1, 0)
#define FAST_CHARGE_SAFETY_TIMER_TMOUT_192MIN	0
#define FAST_CHARGE_SAFETY_TIMER_TMOUT_384MIN	1
#define FAST_CHARGE_SAFETY_TIMER_TMOUT_768MIN	2
#define FAST_CHARGE_SAFETY_TIMER_TMOUT_1536MIN	3
/* safety timer */
...
#if defined(CONFIG_SOMC_CHARGER_EXTENSION)
#define HVDCP_PULSE_COUNT_MAX_CFG_REG		(USBIN_BASE + 0x5B)
#define HVDCP_PULSE_COUNT_MAX_QC3P0		GENMASK(5, 0)
#define HVDCP_PULSE_COUNT_MAX_QC2P0		GENMASK(7, 6)
#define QC3P0_MAX_PULSE_5V 			0
#define QC3P0_MAX_PULSE_9V			20
#define QC3P0_MAX_PULSE_12V			35
#define QC2P0_MAX_PULSE_5V 			0
#define QC2P0_MAX_PULSE_9V			BIT(6)
...
#if defined(CONFIG_SOMC_CHARGER_EXTENSION)
#define AICL_USE_SW_AFTER_APSD			BIT(4)
#define USBIN_IN_COLLAPSE_GF_SEL		GENMASK(1, 0)
#define USBIN_IN_COLLAPSE_GF_1MS		0
#define USBIN_IN_COLLAPSE_GF_5MS		1
...
#if defined(CONFIG_SOMC_CHARGER_EXTENSION)
#define USBIN_9V_AICL_THRESHOLD_7P2V		0
#define USBIN_9V_AICL_THRESHOLD_7P6V		2
#endif
