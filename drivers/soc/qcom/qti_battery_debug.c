...
static ssize_t iusb0_tot_votable_status_show(const struct class *c,
...
static ssize_t fcc_0_votable_status_show(const struct class *c,
					const struct class_attribute *attr, char *buf)
{
	int id;
	ssize_t size;
...
static ssize_t fv_0_votable_status_show(const struct class *c,
					const struct class_attribute *attr, char *buf)
{
	int id;
	ssize_t size;
