...
static struct msm_panel_info *get_panel_info(void)
{
	...
	mipi_video_tmd_panel.lcdc.h_front_porch = 178;
	mipi_video_tmd_panel.lcdc.h_pulse_width = 3;
	mipi_video_tmd_panel.lcdc.v_back_porch = 3;
	mipi_video_tmd_panel.lcdc.v_front_porch = 59;
	...
	mipi_video_tmd_panel.mipi.rgb_swap = DSI_RGB_SWAP_RGB;
...
const struct panel_id tmd_video_wxga_mdw30_panel_id = {
