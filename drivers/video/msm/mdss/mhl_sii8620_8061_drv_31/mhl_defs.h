...
typedef struct SI_PACK_THIS_STRUCT _MHL3_hev_dtd_t {
	MHL3_hev_dtd_a_payload_t a;
	MHL3_hev_dtd_b_payload_t b;
}MHL3_hev_dtd_t ,*PMHL3_hev_dtd_t ;
...
#ifdef SWWA_28919
	MHL_MSC_MSG_TTR				= 0xF0,
	MHL_MSC_MSG_TTRK			= 0xF1,
#endif
};
...
/* Extended Device Capability Registers 18.2.1 */
enum {
...
/* XDEVCAP - TMDS Speeds 18.2.1.2 */
#define MHL_XDC_TMDS_000				0x00
#define MHL_XDC_TMDS_150				0x01
#define MHL_XDC_TMDS_300				0x02
#define MHL_XDC_TMDS_600				0x04

/* XDEVCAP - eCBUS Channel Count Supported 18.2.1.3 */
#define MHL_XDC_TDM_SUPP				0x02

/* XDEVCAP - Device Roles 18.2.1.4 */
#define MHL_XDC_DEV_HOST				0x01
#define MHL_XDC_DEV_DEVICE				0x02
#define MHL_XDC_DEV_CHARGER				0x04

/* XDEVCAP - Cable Report 18.2.1.5 */
#define MHL_XDC_CABLE_TYPE_LEGACY		0x00
#define MHL_XDC_CABLE_TYPE_MHL3			0x01
...
#define BS_AV_PATTERN_LFSR			0x01
