...
#define BIT_PAGE_0_SYS_CTRL1_OTP_AUTO_LOAD_EN              (0x01 << 4)
#define BIT_PAGE_0_SYS_CTRL1_EDGE                          (0x01 << 1)
...
#define BIT_PAGE_0_INTR3_INTR3_STAT3                       (0x01 << 3)
...
#define MSK_PAGE_2_RX_HDMI_CTRL2_IDLE_CNT                  (0x0F << 4)
...
#define MSK_PAGE_3_MHL_PLL_CTL0_AUD_CLK_RATIO              (0x07 << 4)
#define MSK_PAGE_3_MHL_PLL_CTL0_HDMI_CLK_RATIO             (0x03 << 2)
#define BIT_PAGE_3_MHL_PLL_CTL0_HDMI_CLK_RATIO             (0x02 << 2)
#define BIT_PAGE_3_MHL_PLL_CTL0_HDMI_CLK_RATIO             (0x02 << 2)
