...
ifeq ($(CPPUTEST_USE_REAL_GTEST), N)
	#removed -Wall, -Wconversion , -Wswitch-default,  -Wshadow, -Wextra
	CPPUTEST_WARNINGFLAGS = -Werror -Wswitch-enum
ifeq ($(CPPUTEST_PEDANTIC_ERRORS), Y)
	#removed -pedantic-errors. See http://stackoverflow.com/questions/10906238/warning-when-using-bitfield-with-unsigned-char.
