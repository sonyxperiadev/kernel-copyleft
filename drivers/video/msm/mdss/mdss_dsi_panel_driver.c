...
bool mdss_dsi_panel_driver_is_power_on(incell_state state)
{
	bool ret = false;
...
bool mdss_dsi_panel_driver_is_power_lock(incell_state state)
{
	bool ret = false;
...
bool mdss_dsi_panel_driver_is_ewu(incell_state state)
{
	bool ret = false;
...
static void mdss_dsi_panel_driver_state_s_off(incell_state *state)
{
	switch (*state) {
...
static void mdss_dsi_panel_driver_state_p_off(incell_state *state)
{
	switch (*state) {
	case INCELL_STATE_SLE000_P1:
		*state = INCELL_STATE_SLE000_P0;
...
static void mdss_dsi_panel_driver_state_sp_off(incell_state *state)
{
	switch (*state) {
	case INCELL_STATE_SLE000_P1:
	case INCELL_STATE_SLE100_P1:
...
void mdss_dsi_panel_driver_state_change_off(struct incell_ctrl *incell)
{
	...
	case INCELL_STATE_S_OFF:
		mdss_dsi_panel_driver_state_s_off(state);
		break;
	case INCELL_STATE_P_OFF:
		mdss_dsi_panel_driver_state_p_off(state);
		break;
	case INCELL_STATE_SP_OFF:
		mdss_dsi_panel_driver_state_sp_off(state);
		break;
	default:
...
static void mdss_dsi_panel_driver_state_s_on(incell_state *state)
{
	switch (*state) {
...
static void mdss_dsi_panel_driver_state_p_on(incell_state *state)
{
	switch (*state) {
	case INCELL_STATE_SLE000_P0:
		*state = INCELL_STATE_SLE000_P1;
...
static void mdss_dsi_panel_driver_state_sp_on(incell_state *state)
{
	switch (*state) {
	case INCELL_STATE_SLE000_P0:
	case INCELL_STATE_SLE000_P1:
...
void mdss_dsi_panel_driver_state_change_on(struct incell_ctrl *incell)
{
	...
	case INCELL_STATE_S_ON:
		mdss_dsi_panel_driver_state_s_on(state);
		break;
	case INCELL_STATE_P_ON:
		mdss_dsi_panel_driver_state_p_on(state);
		break;
	case INCELL_STATE_SP_ON:
		mdss_dsi_panel_driver_state_sp_on(state);
		break;
	default:
