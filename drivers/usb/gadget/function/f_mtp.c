...
#define MTP_RX_BUFFER_INIT_SIZE    2097152 //default 1048576
#define MTP_TX_BUFFER_INIT_SIZE    2097152 //default 1048576
...
#define MTP_TX_REQ_MAX 20 //default 8
#define RX_REQ_MAX 2
				...
				list_for_each_entry(f, &cfg->functions, list) {
					...
					if (!strncmp(f->name, "mtp", 3)) {
						memcpy(func->compatibleID,
							"MTP", 3);
						VDBG(cdev,
							"MTP interface found. Interface_num: %d.\n",
							interface_num);
					}
					func++;
					func_num++;
