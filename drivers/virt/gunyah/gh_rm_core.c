...
EXPORT_SYMBOL_GPL(gh_get_image_name);
...
EXPORT_SYMBOL_GPL(gh_get_vm_name);
...
EXPORT_SYMBOL_GPL(gh_rm_virq_to_irq);
...
EXPORT_SYMBOL_GPL(gh_rm_irq_to_virq);
...
EXPORT_SYMBOL_GPL(gh_rm_set_virtio_mmio_cb);
...
EXPORT_SYMBOL_GPL(gh_rm_unset_virtio_mmio_cb);
...
EXPORT_SYMBOL_GPL(gh_rm_set_wdog_manage_cb);
...
EXPORT_SYMBOL_GPL(gh_rm_set_vcpu_affinity_cb);
...
EXPORT_SYMBOL_GPL(gh_rm_reset_vcpu_affinity_cb);
...
EXPORT_SYMBOL_GPL(gh_rm_set_vpm_grp_cb);
...
EXPORT_SYMBOL_GPL(gh_rm_reset_vpm_grp_cb);
...
EXPORT_SYMBOL_GPL(gh_rm_all_res_populated_cb);
