...
#define SHORT_IRQF_FLAGS	(SHORT_IRQF_DISABLED | IRQF_ONESHOT | IRQF_TRIGGER_HIGH | IRQF_TRIGGER_RISING)

#define AOD_PENDING_NONE        0
#define AOD_PENDING_ON          1
#define AOD_PENDING_OFF         2
...
struct panel_specific_pdata {
	...
	struct dsi_panel_cmd_set uv_read_cmds;
	u32 u_data;
	u32 v_data;
	int color_mode;
