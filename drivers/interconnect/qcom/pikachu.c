...
#include <dt-bindings/interconnect/qcom,pikachu.h>
...
static struct qcom_icc_node qhm_i3c_s = {
	.name = "qhm_i3c_s",
	.id = MASTER_I3C_S,
	.channels = 1,
	.buswidth = 4,
	.noc_ops = &qcom_qnoc4_ops,
	.qosbox = &qhm_i3c_s_qos,
	.num_links = 1,
...
static struct qcom_icc_bcm bcm_mm1 = {
	...
	.enable_mask = 0x1,
	.num_nodes = 11,
	.nodes = { &qnm_camnoc_hf, &qsm_mnoc_hf_cfg,
		   &qnm_camnoc_icp, &qnm_camnoc_sf,
		   &qnm_eva, &qnm_mdss_dcp,
		   &qnm_video, &qnm_video_cv_cpu,
		   &qnm_video_v_cpu, &qsm_mnoc_sf_cfg,
		   &qns_mem_noc_sf },
};
...
static struct qcom_icc_desc pikachu_clk_virt = {
...
static struct qcom_icc_desc pikachu_config_noc_cfg = {
	.config = &icc_regmap_config,
...
static struct qcom_icc_desc pikachu_config_noc_main = {
	.config = &icc_regmap_config,
...
static struct qcom_icc_desc pikachu_gem_noc = {
	.config = &icc_regmap_config,
	.nodes = gem_noc_nodes,
...
static struct qcom_icc_desc pikachu_lpass_ag_noc = {
	.config = &icc_regmap_config,
...
static struct qcom_icc_desc pikachu_lpass_lpiaon_noc = {
	.config = &icc_regmap_config,
...
static struct qcom_icc_desc pikachu_lpass_lpicx_noc = {
	.config = &icc_regmap_config,
...
static struct qcom_icc_desc pikachu_mc_virt = {
	.config = &icc_regmap_config,
	.nodes = mc_virt_nodes,
...
static struct qcom_icc_desc pikachu_mmss_noc = {
	.config = &icc_regmap_config,
...
static struct qcom_icc_desc pikachu_nsp_noc = {
	.config = &icc_regmap_config,
	.nodes = nsp_noc_nodes,
...
static struct qcom_icc_desc pikachu_pcie_anoc = {
	.config = &icc_regmap_config,
...
static struct qcom_icc_desc pikachu_system_noc = {
	.config = &icc_regmap_config,
...
static int qnoc_probe(struct platform_device *pdev)
{
	...
	if (ret)
		...
		dev_info(&pdev->dev, "Registered PIKACHU ICC\n");

	return ret;
}

static const struct of_device_id qnoc_of_match[] = {
	{ .compatible = "qcom,pikachu-clk_virt",
	  .data = &pikachu_clk_virt},
	{ .compatible = "qcom,pikachu-config_noc_cfg",
	  .data = &pikachu_config_noc_cfg},
	{ .compatible = "qcom,pikachu-config_noc_main",
	  .data = &pikachu_config_noc_main},
	{ .compatible = "qcom,pikachu-gem_noc",
	  .data = &pikachu_gem_noc},
	{ .compatible = "qcom,pikachu-lpass_ag_noc",
	  .data = &pikachu_lpass_ag_noc},
	{ .compatible = "qcom,pikachu-lpass_lpiaon_noc",
	  .data = &pikachu_lpass_lpiaon_noc},
	{ .compatible = "qcom,pikachu-lpass_lpicx_noc",
	  .data = &pikachu_lpass_lpicx_noc},
	{ .compatible = "qcom,pikachu-mc_virt",
	  .data = &pikachu_mc_virt},
	{ .compatible = "qcom,pikachu-mmss_noc",
	  .data = &pikachu_mmss_noc},
	{ .compatible = "qcom,pikachu-nsp_noc",
	  .data = &pikachu_nsp_noc},
	{ .compatible = "qcom,pikachu-pcie_anoc",
	  .data = &pikachu_pcie_anoc},
	{ .compatible = "qcom,pikachu-system_noc",
	  .data = &pikachu_system_noc},
	{ }
};
...
MODULE_DESCRIPTION("Pikachu NoC driver");
MODULE_LICENSE("GPL");
