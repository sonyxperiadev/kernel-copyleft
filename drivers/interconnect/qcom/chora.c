...
static struct qcom_icc_node qnm_camnoc_icp_disp = {
	.name = "qnm_camnoc_icp_disp",
	.id = MASTER_CAMNOC_ICP_DISP,
	.channels = 1,
	.buswidth = 8,
	.noc_ops = &qcom_qnoc4_ops,
	.num_links = 1,
...
static struct qcom_icc_node qnm_camnoc_sf_disp = {
	.name = "qnm_camnoc_sf_disp",
	.id = MASTER_CAMNOC_SF_DISP,
	.channels = 1,
	.buswidth = 32,
	.noc_ops = &qcom_qnoc4_ops,
	.num_links = 1,
...
static struct qcom_icc_node qnm_video_disp = {
	.name = "qnm_video_disp",
	.id = MASTER_VIDEO_DISP,
	.channels = 1,
	.buswidth = 32,
	.noc_ops = &qcom_qnoc4_ops,
	.num_links = 1,
...
static struct qcom_icc_desc chora_aggre1_noc = {
...
static struct qcom_icc_desc chora_clk_virt = {
	.config = &icc_regmap_config,
...
static struct qcom_icc_desc chora_cnoc_cfg = {
	.config = &icc_regmap_config,
...
static struct qcom_icc_desc chora_cnoc_main = {
	.config = &icc_regmap_config,
...
static struct qcom_icc_desc chora_lpass_ag_noc = {
	.config = &icc_regmap_config,
...
static struct qcom_icc_node *mmss_noc_nodes[] = {
	...
	[MASTER_CAMNOC_ICP_DISP] = &qnm_camnoc_icp_disp,
	[MASTER_CAMNOC_SF_DISP] = &qnm_camnoc_sf_disp,
	[MASTER_VIDEO_DISP] = &qnm_video_disp,
...
static struct qcom_icc_desc chora_pcie_anoc = {
	.config = &icc_regmap_config,
...
static struct qcom_icc_desc chora_system_noc = {
	.config = &icc_regmap_config,
...
static int qnoc_probe(struct platform_device *pdev)
{
	...
	if (ret)
		...
		dev_info(&pdev->dev, "Registered CHORA ICC\n");

	return ret;
}

static const struct of_device_id qnoc_of_match[] = {
	{ .compatible = "qcom,chora-aggre1_noc",
	  .data = &chora_aggre1_noc},
	{ .compatible = "qcom,chora-clk_virt",
	  .data = &chora_clk_virt},
	{ .compatible = "qcom,chora-cnoc_cfg",
	  .data = &chora_cnoc_cfg},
	{ .compatible = "qcom,chora-cnoc_main",
	  .data = &chora_cnoc_main},
	{ .compatible = "qcom,chora-gem_noc",
	  .data = &chora_gem_noc},
	{ .compatible = "qcom,chora-lpass_ag_noc",
	  .data = &chora_lpass_ag_noc},
	{ .compatible = "qcom,chora-mc_virt",
	  .data = &chora_mc_virt},
	{ .compatible = "qcom,chora-mmss_noc",
	  .data = &chora_mmss_noc},
	{ .compatible = "qcom,chora-pcie_anoc",
	  .data = &chora_pcie_anoc},
	{ .compatible = "qcom,chora-system_noc",
	  .data = &chora_system_noc},
	{ }
};
...
MODULE_DESCRIPTION("Chora NoC driver");
MODULE_LICENSE("GPL");
