...
static struct qcom_icc_desc kera_aggre1_noc = {
...
static struct qcom_icc_desc kera_aggre2_noc = {
	.config = &icc_regmap_config,
...
static struct qcom_icc_desc kera_cnoc_cfg = {
	.config = &icc_regmap_config,
...
static struct qcom_icc_desc kera_cnoc_main = {
	.config = &icc_regmap_config,
...
static struct qcom_icc_desc kera_lpass_ag_noc = {
	.config = &icc_regmap_config,
...
static struct qcom_icc_desc kera_lpass_lpiaon_noc = {
	.config = &icc_regmap_config,
...
static struct qcom_icc_desc kera_lpass_lpicx_noc = {
	.config = &icc_regmap_config,
...
static struct qcom_icc_desc kera_nsp_noc = {
	.config = &icc_regmap_config,
	.nodes = nsp_noc_nodes,
...
static struct qcom_icc_desc kera_system_noc = {
	.config = &icc_regmap_config,
...
static int qnoc_probe(struct platform_device *pdev)
{
	...
	if (ret)
		...
		dev_info(&pdev->dev, "Registered Kera ICC provider\n");
...
static const struct of_device_id qnoc_of_match[] = {
	{ .compatible = "qcom,kera-aggre1_noc",
	  .data = &kera_aggre1_noc},
	{ .compatible = "qcom,kera-aggre2_noc",
	  .data = &kera_aggre2_noc},
	...
	{ .compatible = "qcom,kera-lpass_ag_noc",
	  .data = &kera_lpass_ag_noc},
	{ .compatible = "qcom,kera-lpass_lpiaon_noc",
	  .data = &kera_lpass_lpiaon_noc},
	{ .compatible = "qcom,kera-lpass_lpicx_noc",
	  .data = &kera_lpass_lpicx_noc},
...
MODULE_DESCRIPTION("Kera NoC driver");
MODULE_LICENSE("GPL");
