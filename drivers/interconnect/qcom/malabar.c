...
#include <dt-bindings/interconnect/qcom,malabar.h>
#include <linux/clk.h>
...
static struct qcom_icc_desc malabar_bimc = {
	.nodes = bimc_nodes,
...
static struct qcom_icc_desc malabar_clk_virt = {
...
static struct qcom_icc_desc malabar_config_noc = {
...
static struct qcom_icc_desc malabar_mmnrt_virt = {
...
static struct qcom_icc_desc malabar_mmrt_virt = {
...
static struct qcom_icc_desc malabar_sys_noc = {
	.nodes = sys_noc_nodes,
...
static const struct of_device_id qnoc_of_match[] = {
	{ .compatible = "qcom,malabar-bimc",
	  .data = &malabar_bimc},
	{ .compatible = "qcom,malabar-clk_virt",
	  .data = &malabar_clk_virt},
	{ .compatible = "qcom,malabar-config_noc",
	  .data = &malabar_config_noc},
	{ .compatible = "qcom,malabar-mmnrt_virt",
	  .data = &malabar_mmnrt_virt},
	{ .compatible = "qcom,malabar-mmrt_virt",
	  .data = &malabar_mmrt_virt},
	{ .compatible = "qcom,malabar-system_noc",
	  .data = &malabar_sys_noc},
	{ }
};
...
MODULE_DESCRIPTION("Malabar NoC driver");
MODULE_LICENSE("GPL");
