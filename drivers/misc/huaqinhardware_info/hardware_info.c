...
#define HARDWARE_INFO_VERSION   "SM6450"
...
static BOARD_TYPE_TABLE pcba_type_table[] = {
	{.type_value = 0, .pcba_type_name = "QN6813AAN", .pcba_modem_id = "N4"},
	{.type_value = 1, .pcba_type_name = "QN6813AAK", .pcba_modem_id = "K4(K/S)"},
	{.type_value = 2, .pcba_type_name = "QN6813AAR", .pcba_modem_id = "R4(J)"},
	{.type_value = 3, .pcba_type_name = "QN6813AAA", .pcba_modem_id = "A4"},
	{.type_value = 4, .pcba_type_name = "QN6813AAC", .pcba_modem_id = "C2"},
	{.type_value = 5, .pcba_type_name = "UNKNOWN",  .pcba_modem_id = "UNKNOWN"},
};

static BOARD_STAGE_TABLE pcba_stage_tabe[] = {
	{.stage_value_min = 0, .stage_value_max = 100, .pcba_stage_name = "EVT0-1",},
	{.stage_value_min = 150, .stage_value_max = 175, .pcba_stage_name = "EVT0-2",},
	{.stage_value_min = 540, .stage_value_max = 610, .pcba_stage_name = "EVT",},
	{.stage_value_min = 840, .stage_value_max = 960, .pcba_stage_name = "DVT",},
	{.stage_value_min = 1100, .stage_value_max = 1280, .pcba_stage_name = "DVT-V5",},
	{.stage_value_min = 1300, .stage_value_max = 1430, .pcba_stage_name = "DVT-mini",},
	{.stage_value_min = 1440, .stage_value_max = 1580, .pcba_stage_name = "PVT",},
	{.stage_value_min = 1590, .stage_value_max = 1740, .pcba_stage_name = "SS2",},
	{.stage_value_min = 1750, .stage_value_max = 1950, .pcba_stage_name = "MP",},
};
