...
#define HARDWARE_INFO_VERSION   "SM6475"
#define HARDWARE_INFO_WCN       "WCN6755"
#define HWINFO_DRIVER_NAME "HardwareInfo"
#define hwinfo_debug  printk
#define HARDWARE_INFO_NFC  "0xC1"
...
static BOARD_TYPE_TABLE pcba_type_table[] = {
	{.type_value = 0, .pcba_type_name = "QN7526AAN", .pcba_modem_id = "N4(N/J)"},
	{.type_value = 1, .pcba_type_name = "QN7526AAK", .pcba_modem_id = "K4(K/S)"},
	{.type_value = 2, .pcba_type_name = "QN7526AAS", .pcba_modem_id = "S4"},
	{.type_value = 3, .pcba_type_name = "QN7526AAA", .pcba_modem_id = "A4/C2"},
	{.type_value = 4, .pcba_type_name = "QN7526AAN", .pcba_modem_id = "N4(N/J)_V1"},
	{.type_value = 5, .pcba_type_name = "QN7526AAK",  .pcba_modem_id = "K4(K/S)_V1"},
	{.type_value = 6, .pcba_type_name = "QN7526AAA",  .pcba_modem_id = "A4/C2_V1"},
	{.type_value = 7, .pcba_type_name = "UNKNOWN",  .pcba_modem_id = "UNKNOWN"},
};

static BOARD_STAGE_TABLE pcba_stage_tabe[] = {
	{.stage_value_min = 0, .stage_value_max = 0, .pcba_stage_name = "EVT0",},
	{.stage_value_min = 153, .stage_value_max = 173, .pcba_stage_name = "EVT1",},
	{.stage_value_min = 547, .stage_value_max = 605, .pcba_stage_name = "DVT1",},
	{.stage_value_min = 850, .stage_value_max = 950, .pcba_stage_name = "DVT2",},
	{.stage_value_min = 1140, .stage_value_max = 1260, .pcba_stage_name = "PVT",},
	{.stage_value_min = 1700, .stage_value_max = 1910, .pcba_stage_name = "MP",},
};
...
ERR_0:
	return error;
*/
	sprintf(buff_name, "/sys/bus/platform/drivers/ufshcd-qcom/1d84000.ufshc/string_descriptors/product_name");
	return 0;
}
...
ERR_0:
	return error;
*/
	sprintf(buff_name, "/sys/bus/platform/drivers/ufshcd-qcom/1d84000.ufshc/string_descriptors/product_revision");
	return 0;
}
 ...
 static unsigned int get_rom_size(void)
 {
 	...
 	if (strstr(bootargs,"Ufs_size=256")) {
 		ufs_size = 256;
...
static ssize_t show_ufs_product_revision(struct device *dev,
					 ...
					 char *buf)
{
	char ufs_product_revision[256] = { 0 };
