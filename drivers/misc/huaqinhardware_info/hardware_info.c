...
static BOARD_TYPE_TABLE pcba_type_table[] = {
	{.type_value = 0, .pcba_type_name = "QN6382AN4", .pcba_modem_id = "N4"},
	{.type_value = 1, .pcba_type_name = "QN6382AK4", .pcba_modem_id = "K4"},
	{.type_value = 2, .pcba_type_name = "QN6382AR4", .pcba_modem_id = "J4"},
	{.type_value = 3, .pcba_type_name = "QN6382AA4", .pcba_modem_id = "A4"},
	{.type_value = 4, .pcba_type_name = "QN6382AC2", .pcba_modem_id = "C2"},
...
static BOARD_STAGE_TABLE pcba_stage_tabe[] = {
	...
	{.stage_value = 550, .pcba_stage_name = "EVT1",},
	{.stage_value = 900, .pcba_stage_name = "DVT1",},
	{.stage_value = 1200, .pcba_stage_name = "DVT2",},
	{.stage_value = 1485, .pcba_stage_name = "PVT",},
	{.stage_value = 1800, .pcba_stage_name = "SS2",},
};
...
#define STAGE_ADC_NAME_MB "/sys/bus/iio/devices/iio:device2/in_voltage_get_stageid_adc_mb_input"
