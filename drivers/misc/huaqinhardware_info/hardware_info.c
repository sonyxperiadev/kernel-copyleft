...
static BOARD_STAGE_TABLE pcba_stage_tabe[] = {
	{.stage_value = 0, .pcba_stage_name = "EVT0-1",},
	{.stage_value = 163, .pcba_stage_name = "EVT0-2",},
	{.stage_value = 550, .pcba_stage_name = "EVT",},
	{.stage_value = 900, .pcba_stage_name = "DVT",},
	{.stage_value = 1200, .pcba_stage_name = "PVT",},
	{.stage_value = 1500, .pcba_stage_name = "SS2",},
