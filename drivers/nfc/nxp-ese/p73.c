...
static int p61_probe(struct spi_device *spi)
{
	...
	if (ret < 0) {
        ...
        P61_ERR_MSG("%s: eSE power controller nfcc='%s' ,r01='%s' ,r02='%s' ,r03='%s'\n", __func__,
		    p61_dev->nfcc_name, p61_dev->nfcc_name_reserved_r01, p61_dev->nfcc_name_reserved_r02, p61_dev->nfcc_name_reserved_r03);
