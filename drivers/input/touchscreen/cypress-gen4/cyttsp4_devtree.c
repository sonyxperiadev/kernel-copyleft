...
#include <linux/input/cypress-gen4/cyttsp4_btn.h>
#include <linux/input/cypress-gen4/cyttsp4_mt.h>
#include <linux/input/cypress-gen4/cyttsp4_proximity.h>
#include <linux/input/cypress-gen4/cyttsp4_platform.h>
		...
		struct device_node *core_node)
{
	...
	if (fih_get_band_id() == BAND_VIV && fih_get_product_phase() >= PHASE_DP)
		pdata->tp_id_gpio = of_get_named_gpio(core_node, "gpios", 3);
	else
		pdata->tp_id_gpio = of_get_named_gpio(core_node, "gpios", 2);
