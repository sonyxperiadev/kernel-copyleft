...
static int __devinit	file_node_control_probe( struct platform_device *pdev )
{
...
static int __devexit	file_node_control_remove( struct platform_device *pdev )
{
...
static struct platform_driver	file_node_control_device_driver =
{
	...
	.remove		= __devexit_p( file_node_control_remove ),
	.driver		=
	{
