...
/* PERI-FG-TOUCH_CHECK_TTCONFIG-00+[ */
	...
	if (ttconfig_ver_img <= SEAGULL_TTCONFIG_VERSION && ttconfig_ver_img != TULIP_TTCONFIG_VERSION_1 && ttconfig_ver_img != TULIP_TTCONFIG_VERSION_2)
		return -1;
	/* PERI-FG-TOUCH_CHECK_TTCONFIG-01+[ */
	if (ttconfig_ver_img >= TULIP_TTCONFIG_VERSION_DP && fih_get_product_phase() == PHASE_DP)
		return -1;
	/* PERI-FG-TOUCH_CHECK_TTCONFIG-01+] */
#endif
/* PERI-FG-TOUCH_CHECK_TTCONFIG-00+] */
