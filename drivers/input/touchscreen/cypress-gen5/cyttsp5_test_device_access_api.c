...
static int check_get_system_info_response(u8 *buf, u16 read_length)
{
	...
	pr_info("Cypress Manufacturing ID[0]: 0x%02x\n", in->return_data[18]);
	pr_info("Cypress Manufacturing ID[1]: 0x%02x\n", in->return_data[19]);
	pr_info("Cypress Manufacturing ID[2]: 0x%02x\n", in->return_data[20]);
	pr_info("Cypress Manufacturing ID[3]: 0x%02x\n", in->return_data[21]);
	pr_info("Cypress Manufacturing ID[4]: 0x%02x\n", in->return_data[22]);
	pr_info("Cypress Manufacturing ID[5]: 0x%02x\n", in->return_data[23]);
	pr_info("Cypress Manufacturing ID[6]: 0x%02x\n", in->return_data[24]);
	pr_info("Cypress Manufacturing ID[7]: 0x%02x\n", in->return_data[25]);
