...
#include <asm/irq.h>
//CONN-EC-SensorPorting-01- #include <asm/mach/irq.h>
...
static void bma2x2_tap_timeout_handle(unsigned long data)
{
	...
	spin_lock_irqsave(&bma2x2->spin_tap_mutex, flags);
	bma2x2->tap_times = 0;
	spin_unlock_irqrestore(&bma2x2->spin_tap_mutex, flags);
...
#endif
//CONN-EC-SensorRemoveDev-01-	struct input_dev *dev_interrupt;
...
//CONN-EC-SensorPorting-01-]
	...
	spin_lock_init(&data->spin_tap_mutex);
