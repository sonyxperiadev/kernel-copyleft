...
#include <linux/fih_hw_info.h>// PERI-BJ-Add_Different_Threshold_For_Different_Phase-00+
				...
				struct stk3x1x_platform_data *pdata)
{
	...
	unsigned  product_phase = fih_get_product_phase();// PERI-BJ-Add_Different_Threshold_For_Different_Phase-00+
...
/* PERI-BJ-Add_Different_Threshold_For_Different_Phase-00+{ */
    if( product_phase <= PHASE_DP )
    {
        of_property_read_u32(np, "sensortek,ps_thd_h_dp",&temp_val);
        pdata->ps_thd_h = temp_val;
        of_property_read_u32(np, "sensortek,ps_thd_l_dp",&temp_val);
        pdata->ps_thd_l = temp_val;
    }else if( product_phase <= PHASE_SP ){
        of_property_read_u32(np, "sensortek,ps_thd_h_sp",&temp_val);
        pdata->ps_thd_h = temp_val;
        of_property_read_u32(np, "sensortek,ps_thd_l_sp",&temp_val);
        pdata->ps_thd_l = temp_val;
    }else{
