...
//fanjiafeng5  add for pdx213 fingerprint hardware info add begin
...
//fanjiafeng5  add for pdx213 fingerprint hardware info and sn add begin
	case GET_SN:			//0xad
			...
			DEBUG_PRINT("fp_ioctl SN = %x%x%x%x%x%x\n", sn[0], sn[1], sn[2], sn[3], sn[4], sn[5]);
			get_hardware_info_data(HWID_FINGERPRINT,"egistec,et613");
