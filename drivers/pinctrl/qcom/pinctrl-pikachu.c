...
static const struct pinctrl_pin_desc pikachu_pins[] = {
...
static const char *const aoss_cti_groups[] = {
	"gpio51", "gpio53", "gpio55", "gpio56",
	"gpio59", "gpio60", "gpio61", "gpio62",
};

static const char *const aoss_ts_groups[] = {
	"gpio65", "gpio70", "gpio71",  "gpio72",
	"gpio96", "gpio97", "gpio108", "gpio109",
};
...
static const char *const cam_asc_mclk1_groups[] = {
	"gpio44",
};
...
static const char *const egpio_groups[] = {
	"gpio4",   "gpio5",   "gpio6",	 "gpio7",   "gpio10",  "gpio11",
	"gpio12",  "gpio16",  "gpio17",	 "gpio18",  "gpio19",  "gpio28",
	"gpio29",  "gpio47",  "gpio48",	 "gpio49",  "gpio50",  "gpio51",
	"gpio53",  "gpio55",  "gpio56",	 "gpio59",  "gpio60",  "gpio61",
	"gpio62",  "gpio67",  "gpio68",	 "gpio75",  "gpio76",  "gpio77",
	"gpio78",  "gpio79",  "gpio80",	 "gpio81",  "gpio82",  "gpio83",
	"gpio84",  "gpio85",  "gpio86",	 "gpio87",  "gpio88",  "gpio89",
	"gpio90",  "gpio91",  "gpio92",	 "gpio93",  "gpio94",  "gpio95",
	"gpio96",  "gpio97",  "gpio98",	 "gpio99",  "gpio100", "gpio101",
	"gpio102", "gpio103", "gpio106", "gpio107", "gpio108", "gpio109",
	"gpio110", "gpio111", "gpio115", "gpio116",
};
...
static const char *const ibi_i3c_groups[] = {
	"gpio4",  "gpio5",  "gpio16", "gpio17", "gpio20", "gpio21",
	"gpio22", "gpio23", "gpio59", "gpio60", "gpio61", "gpio62",
};
...
static const char *const qdss_cti_groups[] = {
	"gpio47", "gpio54",  "gpio67",	"gpio68",  "gpio69",
	"gpio70", "gpio104", "gpio105", "gpio111", "gpio112",
};
...
static const struct pinfunction pikachu_functions[] = {
	MSM_PIN_FUNCTION(gpio),
	MSM_PIN_FUNCTION(RESOUT_GPIO_N),
	MSM_PIN_FUNCTION(aoss_cti),
	MSM_PIN_FUNCTION(aoss_ts),
	...
	MSM_PIN_FUNCTION(cam_asc_mclk1),
	MSM_PIN_FUNCTION(cam_asc_mclk2),
	MSM_PIN_FUNCTION(cam_asc_mclk4),
	MSM_PIN_FUNCTION(cam_mclk),
	MSM_PIN_FUNCTION(cci0_async_in0),
	MSM_PIN_FUNCTION(cci0_async_in1),
	MSM_PIN_FUNCTION(cci0_async_in2),
	MSM_PIN_FUNCTION(cci0_i2c_scl0),
	MSM_PIN_FUNCTION(cci0_i2c_scl1),
	MSM_PIN_FUNCTION(cci0_i2c_sda0),
	MSM_PIN_FUNCTION(cci0_i2c_sda1),
	MSM_PIN_FUNCTION(cci0_timer0),
	MSM_PIN_FUNCTION(cci0_timer1),
	MSM_PIN_FUNCTION(cci0_timer2),
	MSM_PIN_FUNCTION(cci0_timer3_mira),
	MSM_PIN_FUNCTION(cci0_timer3_mirb),
	MSM_PIN_FUNCTION(cci0_timer4_mira),
	MSM_PIN_FUNCTION(cci0_timer4_mirb),
	MSM_PIN_FUNCTION(cci1_i2c_scl2),
	MSM_PIN_FUNCTION(cci1_i2c_scl4),
	MSM_PIN_FUNCTION(cci1_i2c_sda2),
	MSM_PIN_FUNCTION(cci1_i2c_sda4),
	...
	MSM_PIN_FUNCTION(gcc_gp10_clk),
	MSM_PIN_FUNCTION(gcc_gp11_clk),
...
static const struct msm_pingroup pikachu_groups[] = {
	...
	[4] = PINGROUP(4, qup1_se4_l0, ibi_i3c, i3c_s_sda, pll_clk_aux,
			NA, NA, NA, NA, NA, NA, egpio),
	[5] = PINGROUP(5, qup1_se4_l1, ibi_i3c, i3c_s_scl, NA, NA, NA,
			NA, NA, NA, NA, egpio),
	[6] = PINGROUP(6, qup1_se4_l2, NA, phase_flag11, NA, NA, NA,
			NA, NA, NA, NA, egpio),
	[7] = PINGROUP(7, qup1_se4_l3, pcie1_rst_n, NA, NA, NA, NA, NA,
			NA, NA, NA, egpio),
	[8] = PINGROUP(8, qup1_se2_l0, phase_flag20, NA, NA, NA, NA, NA,
			NA, NA, NA, NA),
	[9] = PINGROUP(9, qup1_se2_l1, phase_flag15, NA, NA, NA, NA, NA,
			NA, NA, NA, NA),
	[10] = PINGROUP(10, phase_flag7, NA, NA, NA, NA, NA, NA, NA, NA,
			NA, egpio),
	[11] = PINGROUP(11, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, egpio),
	[12] = PINGROUP(12, mdp_vsync, qup0_se0_l2, qup0_se3_l4, qspi0_clk, mdp_vsync0_out,
			audio_ext_mclk0, mdp_vsync1_out, NA, NA, NA, egpio),
	[13] = PINGROUP(13, mdp_vsync, qup0_se0_l3, mdp_vsync2_out, audio_ext_mclk1,
			audio_ref_clk, mdp_vsync3_out, NA, NA, NA, NA, NA),
	[14] = PINGROUP(14, qup1_se5_l2, phase_flag16, NA, qdss_gpio_tracedata15,
			NA, NA, NA, NA, NA, NA, NA),
	[15] = PINGROUP(15, qup1_se5_l3, phase_flag28, NA, qdss_gpio_tracedata11,
			NA, NA, NA, NA, NA, NA, NA),
	[16] = PINGROUP(16, qup0_se3_l0, i2s0_data0, qspi0_data0, pwm_6, ibi_i3c,
			NA, NA, NA, NA, NA, egpio),
	[17] = PINGROUP(17, qup0_se3_l1, i2s0_data1, qspi0_data1, pwm_7, ibi_i3c,
			NA, NA, NA, NA, NA, egpio),
	[18] = PINGROUP(18, qup0_se3_l2, i2s0_sck, qspi0_data2, pwm_8, NA, NA, NA,
			NA, NA, NA, egpio),
	[19] = PINGROUP(19, qup0_se3_l3, i2s0_ws, qspi0_data3, pwm_9, mdp_vsync_e,
			NA, NA, NA, NA, NA, egpio),
	[20] = PINGROUP(20, qup0_se4_l0, ibi_i3c, NA, NA, NA, NA, NA, NA, NA, NA,
			NA),
	[21] = PINGROUP(21, qup0_se4_l1, ibi_i3c, NA, NA, NA, NA, NA, NA, NA, NA,
			NA),
	[22] = PINGROUP(22, qup0_se4_l2, qup0_se0_l0, ibi_i3c, NA, NA, NA, NA, NA,
			NA, NA, NA),
	[23] = PINGROUP(23, qup0_se4_l3, qup0_se0_l1, ibi_i3c, NA, NA, NA, NA, NA,
			NA, NA, NA),
	[24] = PINGROUP(24, qup1_se1_l0, qdss_gpio_tracedata8, NA, NA, NA, NA, NA,
			NA, NA, NA, NA),
	[25] = PINGROUP(25, qup1_se1_l1, qdss_gpio_tracedata9, NA, NA, NA, NA, NA,
			NA, NA, NA, NA),
	[26] = PINGROUP(26, qup1_se1_l2, qdss_gpio_tracedata2, NA, NA, NA, NA, NA,
			NA, NA, NA, NA),
	[27] = PINGROUP(27, qup1_se1_l3, qdss_gpio_tracedata0, NA, NA, NA, NA, NA,
			NA, NA, NA, NA),
	[28] = PINGROUP(28, qup1_se3_l2, cci0_timer3_mirb, phase_flag2, NA, NA, NA,
			NA, NA, NA, NA, egpio),
	[29] = PINGROUP(29, qup1_se3_l3, cci0_timer4_mirb, phase_flag3, NA, NA, NA,
			NA, NA, NA, NA, egpio),
	[30] = PINGROUP(30, sdc2_cmd, qdss_gpio_tracedata3, tsense_pwm1, NA, NA, NA,
			NA, NA, NA, NA, NA),
	[31] = PINGROUP(31, sdc2_data, qdss_gpio_tracedata1, NA, NA, NA, NA, NA, NA,
			NA, NA, NA),
	[32] = PINGROUP(32, sdc2_clk, qdss_gpio_tracedata5, NA, NA, NA, NA, NA, NA,
			NA, NA, NA),
	[33] = PINGROUP(33, wcn_sw_ctrl, phase_flag17, NA, qdss_gpio_tracedata10,
			atest_char3, NA, NA, NA, NA, NA, NA),
	[34] = PINGROUP(34, mdp_vsync, prng_rosc0, tmess_prng0, NA, NA, NA, NA, NA,
			NA, NA, NA),
	[35] = PINGROUP(35, mdp_vsync, prng_rosc1, tmess_prng1, NA, NA, NA, NA, NA,
			NA, NA, NA),
	[36] = PINGROUP(36, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	[37] = PINGROUP(37, sdc2_data, qdss_gpio_tracectl, NA, NA, NA, NA, NA, NA,
			NA, NA, NA),
	[38] = PINGROUP(38, pcie0_clk_req_n, sdc2_data, qdss_gpio_tracedata7, NA, NA,
			NA, NA, NA, NA, NA, NA),
	[39] = PINGROUP(39, sdc2_data, gcc_gp3, qdss_gpio_traceclk, NA, NA, NA, NA,
			NA, NA, NA, NA),
	[40] = PINGROUP(40, pcie1_clk_req_n, NA, phase_flag18, NA, atest_char_start,
			NA, NA, NA, NA, NA, NA),
	[41] = PINGROUP(41, qup0_se1_l2, pwm_2, ddr_bist_fail, NA, NA, NA, NA, NA,
			NA, NA, NA),
	[42] = PINGROUP(42, qup0_se1_l3, pwm_3, ddr_bist_start, NA, NA, NA, NA, NA,
			NA, NA, NA),
	[43] = PINGROUP(43, cam_mclk, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	[44] = PINGROUP(44, cam_asc_mclk1, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	[45] = PINGROUP(45, cam_asc_mclk2, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	[46] = PINGROUP(46, cam_asc_mclk4, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	[47] = PINGROUP(47, cci0_i2c_sda1, cci0_timer0, prng_rosc2, tmess_prng2,
			phase_flag19, NA, qdss_cti, NA, NA, NA, egpio),
	[48] = PINGROUP(48, cci0_timer1, prng_rosc3, tmess_prng3, NA, NA, NA, NA,
			NA, NA, NA, egpio),
	[49] = PINGROUP(49, cci0_timer2, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			egpio),
	[50] = PINGROUP(50, cci0_timer4_mira, NA, NA, NA, NA, NA, NA, NA, NA,
			NA, egpio),
	[51] = PINGROUP(51, aoss_cti, tgu_ch0_trigout, NA, NA, NA, NA, NA, NA,
			NA, NA, egpio),
	[52] = PINGROUP(52, cci0_async_in1, NA, NA, NA, NA, NA, NA, NA, NA,
			NA, NA),
	[53] = PINGROUP(53, cci0_i2c_scl1, NA, aoss_cti, NA, NA, NA, NA, NA,
			NA, NA, egpio),
	[54] = PINGROUP(54, cci0_async_in2, qdss_cti, NA, NA, NA, NA, NA, NA,
			NA, NA, NA),
	[55] = PINGROUP(55, qup1_se0_l2, aoss_cti, NA, NA, NA, NA, NA, NA, NA,
			NA, egpio),
	[56] = PINGROUP(56, qup1_se0_l3, aoss_cti, NA, NA, NA, NA, NA, NA, NA,
			NA, egpio),
	[57] = PINGROUP(57, cci0_i2c_sda0, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	[58] = PINGROUP(58, cci0_i2c_scl0, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	[59] = PINGROUP(59, cci1_i2c_sda2, qup1_se3_l0, ibi_i3c, aoss_cti, NA, NA,
			NA, NA, NA, NA, egpio),
	[60] = PINGROUP(60, cci1_i2c_scl2, qup1_se3_l1, ibi_i3c, aoss_cti, NA, NA,
			NA, NA, NA, NA, egpio),
	[61] = PINGROUP(61, cci1_i2c_sda4, qup1_se0_l0, ibi_i3c, gcc_gp1, aoss_cti,
			NA, NA, NA, NA, NA, egpio),
	[62] = PINGROUP(62, cci1_i2c_scl4, qup1_se0_l1, ibi_i3c, gcc_gp2, aoss_cti,
			NA, NA, NA, NA, NA, egpio),
	[63] = PINGROUP(63, qup0_se2_l4, pwm_4, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	[64] = PINGROUP(64, qup0_se4_l4, pwm_5, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	[65] = PINGROUP(65, aoss_ts, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	[66] = PINGROUP(66, RESOUT_GPIO_N, NA, qdss_gpio_tracedata6, NA, NA, NA,
			NA, NA, NA, NA, NA),
	[67] = PINGROUP(67, qup0_se5_l0, ddr_bist_complete, qdss_cti, NA, NA,
			NA, NA, NA, NA, NA, egpio),
	[68] = PINGROUP(68, qup0_se5_l1, ddr_bist_stop, qdss_cti, NA, NA, NA, NA,
			NA, NA, NA, egpio),
	[69] = PINGROUP(69, phase_flag23, qdss_cti, NA, qdss_cti, ddr_pxi0, NA, NA,
			NA, NA, NA, NA),
	[70] = PINGROUP(70, aoss_ts, wcn_sw, phase_flag12, qdss_cti, NA, qdss_cti,
			ddr_pxi0, NA, NA, NA, NA),
	[71] = PINGROUP(71, aoss_ts, phase_flag6, NA, qdss_gpio_tracedata14, atest_char0,
			NA, NA, NA, NA, NA, NA),
	[72] = PINGROUP(72, aoss_ts, qdss_gpio_tracedata4, NA, NA, NA, NA, NA, NA, NA,
			NA, NA),
	[73] = PINGROUP(73, host2wlan_sol, phase_flag25, NA, qdss_gpio_tracedata12,
			atest_char1, NA, NA, NA, NA, NA, NA),
	[74] = PINGROUP(74, phase_flag26, NA, qdss_gpio_tracedata13, atest_char2, NA,
			NA, NA, NA, NA, NA, NA),
	[75] = PINGROUP(75, phase_flag29, NA, NA, NA, NA, NA, NA, NA, NA, NA, egpio),
	[76] = PINGROUP(76, usb0_hs, phase_flag30, NA, NA, NA, NA, NA, NA, NA, NA,
			egpio),
	[77] = PINGROUP(77, phase_flag31, NA, NA, NA, NA, NA, NA, NA, NA, NA, egpio),
	[78] = PINGROUP(78, phase_flag4, NA, NA, NA, NA, NA, NA, NA, NA, NA, egpio),
	[79] = PINGROUP(79, phase_flag5, NA, NA, NA, NA, NA, NA, NA, NA, NA, egpio),
	[80] = PINGROUP(80, dbg_out_clk, vsense_trigger_mirnat, atest_usb0, NA, NA,
			NA, NA, NA, NA, NA, egpio),
	[81] = PINGROUP(81, phase_flag21, NA, NA, NA, NA, NA, NA, NA, NA, NA, egpio),
	[82] = PINGROUP(82, phase_flag22, NA, NA, NA, NA, NA, NA, NA, NA, NA, egpio),
	[83] = PINGROUP(83, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, egpio),
	[84] = PINGROUP(84, jitter_bist, NA, NA, NA, NA, NA, NA, NA, NA, NA, egpio),
	[85] = PINGROUP(85, phase_flag13, NA, NA, NA, NA, NA, NA, NA, NA, NA, egpio),
	[86] = PINGROUP(86, phase_flag14, NA, NA, NA, NA, NA, NA, NA, NA, NA, egpio),
	[87] = PINGROUP(87, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, egpio),
	[88] = PINGROUP(88, tb_trig_sdc1, NA, atest_usb00, NA, NA, NA, NA, NA,
			NA, NA, egpio),
	[89] = PINGROUP(89, phase_flag1, NA, NA, NA, NA, NA, NA, NA, NA, NA, egpio),
	[90] = PINGROUP(90, phase_flag8, NA, NA, NA, NA, NA, NA, NA, NA, NA, egpio),
	[91] = PINGROUP(91, tb_trig_sdc2, atest_usb03, NA, NA, NA, NA, NA, NA,
			NA, NA, egpio),
	[92] = PINGROUP(92, phase_flag0, NA, NA, NA, NA, NA, NA, NA, NA, NA, egpio),
	[93] = PINGROUP(93, NA, atest_usb01, NA, NA, NA, NA, NA, NA, NA, NA, egpio),
	[94] = PINGROUP(94, atest_usb02, NA, NA, NA, NA, NA, NA, NA, NA, NA, egpio),
	[95] = PINGROUP(95, phase_flag9, NA, NA, NA, NA, NA, NA, NA, NA, NA, egpio),
	[96] = PINGROUP(96, aoss_ts, phase_flag24, NA, NA, NA, NA, NA, NA, NA,
			NA, egpio),
	[97] = PINGROUP(97, aoss_ts, gcc_gp11_clk, NA, NA, NA, NA, NA, NA, NA,
			NA, egpio),
	[98] = PINGROUP(98, gcc_gp1, NA, NA, NA, NA, NA, NA, NA, NA, NA, egpio),
	[99] = PINGROUP(99, gcc_gp2, NA, NA, NA, NA, NA, NA, NA, NA, NA, egpio),
	[100] = PINGROUP(100, gcc_gp3, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			egpio),
	[101] = PINGROUP(101, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, egpio),
	[102] = PINGROUP(102, gcc_gp4_clk, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			egpio),
	[103] = PINGROUP(103, gcc_gp5_clk, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			egpio),
	[104] = PINGROUP(104, pll_bist_sync, gcc_gp6_clk, NA, qdss_cti, NA, NA,
			NA, NA, NA, NA, NA),
	[105] = PINGROUP(105, gcc_gp9_clk, NA, qdss_cti, NA, NA, NA, NA, NA, NA,
			NA, NA),
	[106] = PINGROUP(106, gcc_gp7_clk, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			egpio),
	[107] = PINGROUP(107, gcc_gp8_clk, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			egpio),
	[108] = PINGROUP(108, aoss_ts, gcc_gp10_clk, NA, NA, NA, NA, NA, NA,
			NA, NA, egpio),
	[109] = PINGROUP(109, aoss_ts, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			egpio),
	[110] = PINGROUP(110, qup0_se1_l0, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			egpio),
	[111] = PINGROUP(111, qup0_se1_l1, qdss_cti, NA, NA, NA, NA, NA, NA,
			NA, NA, egpio),
	[112] = PINGROUP(112, qup1_se5_l0, qup1_se2_l2, phase_flag10, NA, qdss_cti,
			NA, NA, NA, NA, NA, NA),
	[113] = PINGROUP(113, qup1_se5_l1, qup1_se2_l3, phase_flag27, NA, NA, NA,
			NA, NA, NA, NA, NA),
	[114] = PINGROUP(114, cci0_async_in0, cci0_timer3_mira, NA, NA, NA, NA,
			NA, NA, NA, NA, NA),
	[115] = PINGROUP(115, qup0_se5_l2, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			egpio),
...
static const struct msm_gpio_wakeirq_map pikachu_pdc_map[] = {
	...
	{ 5, 86 },    { 6, 159 },   { 7, 124 },	  { 11, 75 },	{ 12, 151 },
	{ 13, 80 },   { 15, 84 },   { 16, 152 },  { 17, 153 },	{ 18, 142 },
	{ 19, 88 },   { 20, 89 },   { 21, 143 },  { 22, 71 },	{ 23, 90 },
	{ 24, 144 },  { 27, 91 },   { 28, 92 },	  { 29, 93 },	{ 30, 95 },
	{ 31, 96 },   { 32, 97 },   { 33, 155 },  { 34, 156 },	{ 35, 98 },
	{ 37, 157 },  { 38, 81 },   { 39, 100 },  { 40, 82 },	{ 41, 158 },
	{ 42, 83 },   { 47, 72 },   { 48, 146 },  { 49, 112 },	{ 50, 161 },
	{ 51, 107 },  { 52, 102 },  { 53, 85 },	  { 54, 108 },	{ 56, 110 },
	{ 59, 113 },  { 60, 114 },  { 61, 115 },  { 63, 117 },	{ 64, 118 },
	{ 66, 120 },  { 67, 121 },  { 68, 122 },  { 69, 123 },	{ 70, 87 },
	{ 71, 104 },  { 72, 105 },  { 74, 106 },  { 75, 125 },	{ 76, 126 },
	{ 77, 162 },  { 78, 163 },  { 79, 128 },  { 80, 119 },	{ 81, 130 },
	{ 82, 127 },  { 84, 131 },  { 86, 164 },  { 87, 134 },	{ 88, 165 },
	{ 89, 103 },  { 91, 132 },  { 92, 133 },  { 93, 109 },	{ 95, 136 },
	{ 96, 149 },  { 97, 99 },   { 98, 139 },  { 100, 148 }, { 102, 116 },
	{ 103, 73 },  { 104, 129 }, { 105, 111 }, { 106, 74 },	{ 107, 145 },
	{ 108, 135 }, { 110, 150 }, { 111, 77 },  { 112, 76 },	{ 113, 78 },
	{ 114, 79 },  { 116, 140 },
};

static const struct msm_pinctrl_soc_data pikachu_tlmm = {
	.pins = pikachu_pins,
	...
	.ngpios = 117,
	.wakeirq_map = pikachu_pdc_map,
	.nwakeirq_map = ARRAY_SIZE(pikachu_pdc_map),
	.egpio_func = 11,
};
...
static int pikachu_tlmm_probe(struct platform_device *pdev)
{
	...
	return msm_pinctrl_probe(pdev, &pikachu_tlmm);
}

static struct platform_driver pikachu_tlmm_driver = {
	.driver = {
		.name = "pikachu-tlmm",
		.of_match_table = pikachu_tlmm_of_match,
	},
	.probe = pikachu_tlmm_probe,
	.remove_new = msm_pinctrl_remove,
};

static int __init pikachu_tlmm_init(void)
{
	return platform_driver_register(&pikachu_tlmm_driver);
}
arch_initcall(pikachu_tlmm_init);

static void __exit pikachu_tlmm_exit(void)
{
	platform_driver_unregister(&pikachu_tlmm_driver);
}
module_exit(pikachu_tlmm_exit);

MODULE_DESCRIPTION("QTI pikachu TLMM driver");
MODULE_LICENSE("GPL");
MODULE_DEVICE_TABLE(of, pikachu_tlmm_of_match);
