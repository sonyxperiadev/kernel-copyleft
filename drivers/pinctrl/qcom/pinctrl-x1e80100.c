...
static const char * const egpio_groups[] = {
	...
	"gpio234", "gpio235", "gpio236", "gpio237",
};
...
static const struct msm_pingroup x1e80100_groups[] = {
	...
	[192] = PINGROUP(192, _, _, _, _, _, _, _, _, egpio),
	[193] = PINGROUP(193, _, _, _, _, _, _, _, _, egpio),
	[194] = PINGROUP(194, _, _, _, _, _, _, _, _, egpio),
	[195] = PINGROUP(195, _, _, _, _, _, _, _, _, egpio),
	[196] = PINGROUP(196, _, _, _, _, _, _, _, _, egpio),
	[197] = PINGROUP(197, _, _, _, _, _, _, _, _, egpio),
	[198] = PINGROUP(198, _, _, _, _, _, _, _, _, egpio),
	[199] = PINGROUP(199, _, _, _, _, _, _, _, _, egpio),
	[200] = PINGROUP(200, _, _, _, _, _, _, _, _, egpio),
	[201] = PINGROUP(201, _, _, _, _, _, _, _, _, egpio),
	[202] = PINGROUP(202, _, _, _, _, _, _, _, _, egpio),
	[203] = PINGROUP(203, _, _, _, _, _, _, _, _, egpio),
	[204] = PINGROUP(204, _, _, _, _, _, _, _, _, egpio),
	[205] = PINGROUP(205, _, _, _, _, _, _, _, _, egpio),
	[206] = PINGROUP(206, _, _, _, _, _, _, _, _, egpio),
	[207] = PINGROUP(207, _, _, _, _, _, _, _, _, egpio),
	[208] = PINGROUP(208, _, _, _, _, _, _, _, _, egpio),
	[209] = PINGROUP(209, _, _, _, _, _, _, _, _, egpio),
	[210] = PINGROUP(210, _, _, _, _, _, _, _, _, egpio),
	[211] = PINGROUP(211, _, _, _, _, _, _, _, _, egpio),
	[212] = PINGROUP(212, _, _, _, _, _, _, _, _, egpio),
	[213] = PINGROUP(213, _, _, _, _, _, _, _, _, egpio),
	[214] = PINGROUP(214, _, _, _, _, _, _, _, _, egpio),
	[215] = PINGROUP(215, _, qdss_cti, _, _, _, _, _, _, egpio),
	[216] = PINGROUP(216, _, _, _, _, _, _, _, _, egpio),
	[217] = PINGROUP(217, _, qdss_cti, _, _, _, _, _, _, egpio),
	[218] = PINGROUP(218, _, _, _, _, _, _, _, _, egpio),
	[219] = PINGROUP(219, _, qdss_gpio, _, _, _, _, _, _, egpio),
	[220] = PINGROUP(220, _, qdss_gpio, _, _, _, _, _, _, egpio),
	[221] = PINGROUP(221, _, qdss_gpio, _, _, _, _, _, _, egpio),
	[222] = PINGROUP(222, _, qdss_gpio, _, _, _, _, _, _, egpio),
	[223] = PINGROUP(223, _, qdss_gpio, _, _, _, _, _, _, egpio),
	[224] = PINGROUP(224, _, qdss_gpio, _, _, _, _, _, _, egpio),
	[225] = PINGROUP(225, _, qdss_gpio, _, _, _, _, _, _, egpio),
	[226] = PINGROUP(226, _, qdss_gpio, _, _, _, _, _, _, egpio),
	[227] = PINGROUP(227, _, qdss_gpio, _, _, _, _, _, _, egpio),
	[228] = PINGROUP(228, _, qdss_gpio, _, _, _, _, _, _, egpio),
	[229] = PINGROUP(229, qdss_gpio, _, _, _, _, _, _, _, egpio),
	[230] = PINGROUP(230, qdss_gpio, _, _, _, _, _, _, _, egpio),
	[231] = PINGROUP(231, qdss_gpio, _, _, _, _, _, _, _, egpio),
	[232] = PINGROUP(232, qdss_gpio, _, _, _, _, _, _, _, egpio),
	[233] = PINGROUP(233, qdss_gpio, _, _, _, _, _, _, _, egpio),
	[234] = PINGROUP(234, qdss_gpio, _, _, _, _, _, _, _, egpio),
	[235] = PINGROUP(235, aon_cci, qdss_gpio, _, _, _, _, _, _, egpio),
	[236] = PINGROUP(236, aon_cci, qdss_gpio, _, _, _, _, _, _, egpio),
	[237] = PINGROUP(237, _, _, _, _, _, _, _, _, egpio),
...
static const struct msm_gpio_wakeirq_map x1e80100_pdc_map[] = {
	{ 0, 72 }, { 2, 70 }, { 3, 71 }, { 6, 123 }, { 7, 67 }, { 11, 85 }, { 13, 86 },
	{ 15, 68 }, { 18, 122 }, { 19, 69 }, { 21, 158 }, { 23, 143 }, { 24, 126 },
	{ 26, 129 }, { 27, 144 }, { 28, 77 }, { 29, 78 }, { 30, 92 }, { 31, 159 },
	{ 32, 145 }, { 33, 115 }, { 34, 130 }, { 35, 146 }, { 36, 147 }, { 38, 113 },
	{ 39, 80 }, { 43, 148 }, { 47, 149 }, { 51, 79 }, { 53, 89 }, { 55, 81 },
	{ 59, 87 }, { 64, 90 }, { 65, 106 }, { 66, 142 }, { 67, 88 }, { 68, 151 },
	{ 71, 91 }, { 75, 152 }, { 79, 153 }, { 80, 125 }, { 81, 128 }, { 83, 154 },
	{ 84, 137 }, { 85, 155 }, { 87, 156 }, { 91, 157 }, { 92, 138 }, { 93, 139 },
	{ 94, 140 }, { 95, 141 }, { 113, 84 }, { 121, 73 }, { 123, 74 }, { 125, 75 },
	{ 129, 76 }, { 131, 82 }, { 134, 83 }, { 141, 93 }, { 144, 94 }, { 145, 95 },
	{ 147, 96 }, { 148, 97 }, { 150, 102 }, { 151, 103 }, { 153, 104 }, { 154, 100 },
	{ 156, 105 }, { 157, 107 }, { 163, 98 }, { 166, 112 }, { 172, 99 }, { 175, 114 },
	{ 181, 101 }, { 184, 116 }, { 193, 117 }, { 196, 108 }, { 203, 133 }, { 208, 134 },
	{ 212, 120 }, { 213, 150 }, { 214, 121 }, { 215, 118 }, { 217, 109 }, { 219, 119 },
	{ 220, 110 }, { 221, 111 }, { 222, 124 }, { 224, 131 }, { 225, 132 }, { 228, 135 },
	{ 230, 116 }, { 232, 162 },
};
