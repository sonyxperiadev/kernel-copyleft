					...
					struct snd_ctl_elem_value *ucontrol)
{
	...
	voc_set_tx_device_mute(voc_get_session_id(VOICE_SESSION_NAME), mute);
					...
					struct snd_ctl_elem_value *ucontrol)
{
	...
	voc_set_tx_device_mute(voc_get_session_id(VOLTE_SESSION_NAME), mute);
					 ...
					 struct snd_ctl_elem_value *ucontrol)
{
	...
	voc_set_tx_device_mute(voc_get_session_id(VOICE2_SESSION_NAME), mute);
...
static struct snd_kcontrol_new msm_voice_controls[] = {
	...
	SOC_SINGLE_EXT("Voice Tx Device Mute", SND_SOC_NOPM, 0, 1, 0,
				msm_voice_tx_device_mute_get,
				msm_voice_tx_device_mute_put),
	SOC_SINGLE_EXT("VoLTE Tx Device Mute", SND_SOC_NOPM, 0, 1, 0,
			msm_volte_tx_device_mute_get,
			msm_volte_tx_device_mute_put),
	SOC_SINGLE_EXT("Voice2 Tx Device Mute", SND_SOC_NOPM, 0, 1, 0,
		       msm_voice2_tx_device_mute_get,
