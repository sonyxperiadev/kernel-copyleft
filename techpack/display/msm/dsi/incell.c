...
int incell_get_display_sod_mode(void)
{
	//Comment out because this function is not necessary for basic function
	//	return dsi_panel_driver_get_display_sod_mode();
	return 0;
}
EXPORT_SYMBOL(incell_get_display_sod_mode);

void incell_control_touch_power(void)
{
	//Comment out because this function is not necessary for basic function
	//struct dsi_display *display = dsi_display_get_main_display();

	//dsi_panel_driver_control_touch_power_off(display);
}
EXPORT_SYMBOL(incell_control_touch_power);
