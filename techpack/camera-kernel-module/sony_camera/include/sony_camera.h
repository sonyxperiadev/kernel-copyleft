...
#define SONY_CAMERA_CMD_GET_POWER_STATE   (SONY_CAMERA_CMD_BASE + 16)
#define SONY_CAMERA_CMD_SET_POWER         (SONY_CAMERA_CMD_BASE + 17)
#define SONY_CAMERA_CMD_START_SOF_EVENT   (SONY_CAMERA_CMD_BASE + 18)
#define SONY_CAMERA_CMD_STOP_SOF_EVENT    (SONY_CAMERA_CMD_BASE + 19)
