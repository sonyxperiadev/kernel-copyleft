...
static ssize_t wls_id_auth_show(struct class *c, struct class_attribute *attr,
								char *buf)
{
	struct somc_bcext_dev *bcext_dev = container_of(c,
					struct somc_bcext_dev, bcext_class);
...
static ssize_t usb2_ccstat_show(struct class *c, struct class_attribute *attr,
								char *buf)
{
	struct somc_bcext_dev *bcext_dev = container_of(c,
					struct somc_bcext_dev, bcext_class);
	...
	somc_bcext_get_prop(bcext_dev, BATTMNGR_SOMC_PROP_CC_STATUS,
								&cc_stat);
...
static ssize_t usb2_nvm_write_show(struct class *c,
					struct class_attribute *attr,char *buf)
{
	struct somc_bcext_dev *bcext_dev = container_of(c,
					struct somc_bcext_dev, bcext_class);
...
static ssize_t restored_capacity_store(struct class *c,
						struct class_attribute *attr,
						const char *buf, size_t count)
{
	struct somc_bcext_dev *bcext_dev = container_of(c,
...
static ssize_t restored_capacity_show(struct class *c,
				struct class_attribute *attr, char *buf)
{
	struct somc_bcext_dev *bcext_dev = container_of(c,
					struct somc_bcext_dev, bcext_class);
...
static ssize_t usb_icl_votable_status_show(struct class *c,
				struct class_attribute *attr, char *buf)
{
	struct somc_bcext_dev *bcext_dev = container_of(c,
					struct somc_bcext_dev, bcext_class);
...
static ssize_t fcc_votable_status_show(struct class *c,
				struct class_attribute *attr, char *buf)
{
	struct somc_bcext_dev *bcext_dev = container_of(c,
					struct somc_bcext_dev, bcext_class);
	...
	size = somc_output_voter_param(bcext_dev->fcc_votable, buf,
								PAGE_SIZE);
...
static ssize_t fake_chg_votable_status_show(struct class *c,
				struct class_attribute *attr, char *buf)
{
	struct somc_bcext_dev *bcext_dev = container_of(c,
					struct somc_bcext_dev, bcext_class);
...
static ssize_t fake_chg_disallow_votable_status_show(struct class *c,
				struct class_attribute *attr, char *buf)
{
	struct somc_bcext_dev *bcext_dev = container_of(c,
					struct somc_bcext_dev, bcext_class);
...
static ssize_t aicl_result_show(struct class *c,
					struct class_attribute *attr, char *buf)
{
	struct somc_bcext_dev *bcext_dev = container_of(c,
					struct somc_bcext_dev, bcext_class);
...
static ssize_t charger_max_wattage_show(struct class *c,
					struct class_attribute *attr, char *buf)
{
	struct somc_bcext_dev *bcext_dev = container_of(c,
					struct somc_bcext_dev, bcext_class);
...
static ssize_t active_charger_type_show(struct class *c,
					struct class_attribute *attr, char *buf)
{
	struct somc_bcext_dev *bcext_dev = container_of(c,
					struct somc_bcext_dev, bcext_class);
...
static ssize_t fcss_err_cnt_show(struct class *c,
					struct class_attribute *attr, char *buf)
{
	struct somc_bcext_dev *bcext_dev = container_of(c,
					struct somc_bcext_dev, bcext_class);
...
static ssize_t weak_limit_current_show(struct class *c,
					struct class_attribute *attr, char *buf)
{
	struct somc_bcext_dev *bcext_dev = container_of(c,
					struct somc_bcext_dev, bcext_class);
...
static ssize_t charger_type_show(struct class *c,
					struct class_attribute *attr, char *buf)
{
	struct somc_bcext_dev *bcext_dev = container_of(c,
					struct somc_bcext_dev, bcext_class);
...
static ssize_t is_pd_charger_used_show(struct class *c,
					struct class_attribute *attr, char *buf)
{
	struct somc_bcext_dev *bcext_dev = container_of(c,
					struct somc_bcext_dev, bcext_class);
...
static ssize_t is_decent_charging_show(struct class *c,
					struct class_attribute *attr, char *buf)
{
	struct somc_bcext_dev *bcext_dev = container_of(c,
					struct somc_bcext_dev, bcext_class);
...
static ssize_t is_fastest_charging_show(struct class *c,
					struct class_attribute *attr, char *buf)
{
	struct somc_bcext_dev *bcext_dev = container_of(c,
					struct somc_bcext_dev, bcext_class);
...
static ssize_t usb2_alert_irq_status_show(struct class *c,
				struct class_attribute *attr, char *buf)
{
	struct somc_bcext_dev *bcext_dev = container_of(c,
					struct somc_bcext_dev, bcext_class);
...
static ssize_t usb2_attach_irq_status_show(struct class *c,
				struct class_attribute *attr, char *buf)
{
	struct somc_bcext_dev *bcext_dev = container_of(c,
					struct somc_bcext_dev, bcext_class);
...
static ssize_t vbat_full_show(struct class *c,
				struct class_attribute *attr, char *buf)
{
	struct somc_bcext_dev *bcext_dev = container_of(c,
					struct somc_bcext_dev, bcext_class);
...
static ssize_t qbg_calc_time_show(struct class *c,
				struct class_attribute *attr, char *buf)
{
	struct somc_bcext_dev *bcext_dev = container_of(c,
					struct somc_bcext_dev, bcext_class);
...
static ssize_t qbg_data_full_cnt_show(struct class *c,
				struct class_attribute *attr, char *buf)
{
	struct somc_bcext_dev *bcext_dev = container_of(c,
					struct somc_bcext_dev, bcext_class);
...
static ssize_t invalid_resistance_cnt_show(struct class *c,
				struct class_attribute *attr, char *buf)
{
	struct somc_bcext_dev *bcext_dev = container_of(c,
					struct somc_bcext_dev, bcext_class);
	...
	somc_bcext_get_prop(bcext_dev, BATTMNGR_SOMC_PROP_INVALID_RESISTANCE_CNT,
...
static ssize_t pmic_reg_addr_store(struct class *c,
						struct class_attribute *attr,
						const char *buf, size_t count)
{
	struct somc_bcext_dev *bcext_dev = container_of(c,
...
static ssize_t pmic_reg_addr_show(struct class *c,
					struct class_attribute *attr, char *buf)
{
	struct somc_bcext_dev *bcext_dev = container_of(c,
					struct somc_bcext_dev, bcext_class);
...
static ssize_t pmic_reg_data_store(struct class *c,
						struct class_attribute *attr,
						const char *buf, size_t count)
{
	struct somc_bcext_dev *bcext_dev = container_of(c,
...
static ssize_t pmic_reg_data_show(struct class *c,
					struct class_attribute *attr, char *buf)
{
	struct somc_bcext_dev *bcext_dev = container_of(c,
					struct somc_bcext_dev, bcext_class);
