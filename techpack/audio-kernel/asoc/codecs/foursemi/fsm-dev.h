...
/* VERSION INFORMATION */
#define FSM_CODE_VERSION "v3.0.5"
#define FSM_CODE_DATE    "20200903"
#define FSM_GIT_BRANCH   "foursemi_fs1958"
#define FSM_GIT_COMMIT   "23749327"

#define FSM_DRV_NAME     "fs16xx"
#define FSM_FW_NAME      "fs16xx.fsm"
// #define FSM_CALIB_FILE   "/data/fsm_calib.bin"
...
#define FSM_PAYLOAD_SIZE      (32)
#ifdef CONFIG_FSM_NONDSP
#define FSM_ALGO_MAGNIF       (256)
#define FSM_SPKR_ALLOWANCE    (30) // percentage: %
#define FSM_RCVR_ALLOWANCE    (20) // percentage: %
#define FSM_MAGNIF(val)       ((val) * 256)
#else
#define FSM_SPKR_ALLOWANCE    (30) // percentage: %
#define FSM_RCVR_ALLOWANCE    (20) // percentage: %
...
#define FREQ_END         600 // bigger than FREQ_START && 100*N
#define F0_FREQ_STEP     100  // 50*N, N =1,2,3...
#define FREQ_COUNT       COUNT(FREQ_START, FREQ_END, F0_FREQ_STEP)
#define FREQ_EXT_COUNT   300
#ifdef CONFIG_FSM_NONDSP
#define RE25_TEST_COUNT  5
//#define RE25_1ST_WAIT_MS 1000
#define RE25_1ST_WAIT_MS 2000 // 2s
#define RE25_DELAY_MS    50
//#define F0_1ST_DELAY_MS  2000
//#define F0_TEST_DELAY_MS 100
#define F0_1ST_DELAY_MS  10000 // 10s
#define F0_TEST_DELAY_MS 50
#else // ndef CONFIG_FSM_NONDSP
...
#define FSM_IOC_UPDATE_RE25 _IOW(FSM_IOC_MAGIC, 12, int)
#define FSM_IOC_SET_SLAVE   (0x0706)
#define FSM_IOC_MAXNR       (13)
#ifdef CONFIG_COMPAT
