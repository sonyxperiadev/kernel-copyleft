...
ifeq ($(call is-board-platform-in-list, lito),true)
$(shell rm -rf $(PRODUCT_OUT)/obj/vendor/qcom/opensource/audio-kernel/asoc/codecs/foursemi/Module.symvers)
include $(MY_LOCAL_PATH)/asoc/codecs/foursemi/Android.mk
endif
