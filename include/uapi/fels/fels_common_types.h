...
typedef enum {
    ...
    /* [3000-4000) is assigned to CHARGER */
    FELS_ERROR_CODE_CHARGER_DETECT_INVALID_BATTERY = 3000,
    FELS_ERROR_CODE_CHARGER_DETECT_PD_HARD_RESET = 3001,
    FELS_ERROR_CODE_CHARGER_DETECT_SOC_FREEZE = 3002,
    FELS_ERROR_CODE_CHARGER_DETECT_WLC_FW_UPDATE = 3003,
    FELS_ERROR_CODE_CHARGER_DETECT_WLC_MANY_ISR = 3004,
    FELS_ERROR_CODE_MAX,
} fels_error_code_t;
