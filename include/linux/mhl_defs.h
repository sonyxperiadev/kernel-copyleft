...
#ifndef __LINUX_MHL_DEFS_H__
#define __LINUX_MHL_DEFS_H__
...
#define MHL_FEATURE_RCP_SUPPORT			BIT(0)
/* Dongles have freedom to not support RAP */
#define MHL_FEATURE_RAP_SUPPORT			BIT(1)
/* Dongles have freedom to not support SCRATCHPAD */
#define MHL_FEATURE_SP_SUPPORT			BIT(2)
...
#define MHL_STATUS_DCAP_RDY			BIT(0)
...
#define MHL_INT_DCAP_CHG			BIT(0)
#define MHL_INT_DSCR_CHG			BIT(1)
#define MHL_INT_REQ_WRT				BIT(2)
#define MHL_INT_GRT_WRT				BIT(3)

/* On INTR_1 the EDID_CHG is located at BIT 0 */
#define MHL_INT_EDID_CHG			BIT(1)
