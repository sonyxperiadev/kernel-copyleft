...
#define SOMC_ADOPTER_ID 935
#define SOMC_RHINE_DEVICE_ID 0x0404
...
#define DEVCAP_VAL_ADOPTER_ID_H    (uint8_t)(SOMC_ADOPTER_ID >>   8)
#define DEVCAP_VAL_ADOPTER_ID_L    (uint8_t)(SOMC_ADOPTER_ID & 0xFF)
...
#define DEVCAP_VAL_DEVICE_ID_H     (uint8_t)(SOMC_RHINE_DEVICE_ID >>   8)
#define DEVCAP_VAL_DEVICE_ID_L     (uint8_t)(SOMC_RHINE_DEVICE_ID & 0xFF)
