...
//TS comment, RID001485 Qnovo adaptive charging E
	POWER_SUPPLY_PROP_TM_DISABLE, //CEI comments, thermal mitigation
	...
	POWER_SUPPLY_PROP_RECHARGE_VOLTAGE,//CEI comments, soft charge v8
	...
	POWER_SUPPLY_PROP_JEITA_EN_CFG,
	POWER_SUPPLY_PROP_JEITA_FVC_CFG,
	POWER_SUPPLY_PROP_JEITA_CCC_CFG
};
...
enum power_supply_type {
	...
	//POWER_SUPPLY_TYPE_USB_FLOAT,    //CEI comment, Invalid charger support Mike, build fail.
};
