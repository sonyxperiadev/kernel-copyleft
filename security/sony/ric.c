...
static struct security_hook_list sony_ric_hooks[] = {
	LSM_HOOK_INIT(sb_mount, sony_ric_mount),
};
...
{
	if (!security_module_enable("sony_ric"))
		return 0;

	security_add_hooks(sony_ric_hooks, ARRAY_SIZE(sony_ric_hooks));
