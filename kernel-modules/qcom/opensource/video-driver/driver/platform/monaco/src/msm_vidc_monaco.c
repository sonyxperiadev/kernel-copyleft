...
static struct msm_platform_core_capability core_data_monaco[] = {
	/* {type, value} */
	...
	{MAX_MBPS_HQ, 244800}, /* 1920 x 1088 @ 30 fps */
...
static struct msm_platform_inst_capability instance_data_monaco[] = {
	/* {cap, domain, codec,
	...
	{FRAME_WIDTH, ENC, CODECS_ALL, 128, 1920, 2, 1920},
	{LOSSLESS_FRAME_WIDTH, ENC, H264|HEVC, 128, 1920, 2, 1920},
	{SECURE_FRAME_WIDTH, DEC, H264|HEVC|VP9, 96, 1920, 1, 1920},
	{SECURE_FRAME_WIDTH, ENC, H264|HEVC, 128, 1920, 2, 1920},
	{FRAME_HEIGHT, DEC, CODECS_ALL, 96, 1920, 1, 1080},
	{FRAME_HEIGHT, ENC, CODECS_ALL, 128, 1920, 2, 1080},
	{LOSSLESS_FRAME_HEIGHT, ENC, H264|HEVC, 128, 1920, 2, 1080},
	{SECURE_FRAME_HEIGHT, DEC, H264|HEVC|VP9, 96, 1920, 1, 1080},
	{SECURE_FRAME_HEIGHT, ENC, H264|HEVC, 128, 1920, 2, 1080},
	{PIX_FMTS, ENC, H264,
		MSM_VIDC_FMT_NV12,
		MSM_VIDC_FMT_NV21,
	...
	{BITRATE_BOOST, ENC, H264|HEVC,
		0, MAX_BITRATE_BOOST, MAX_BITRATE_BOOST, MAX_BITRATE_BOOST,
	...
	{MBPF, ENC, HEIC, 1024, 262144, 1, 262144}, /* ((8192x8192)/256) */
	{MBPS, DEC, HEIC, 64, 262144,  1, 262144 }, /* ((8192x8192)/256)@1fps */
	{MBPS, ENC, HEIC, 1024, 262144, 1, 262144}, /* ((8192x8192)/256)@1fps */
...
static u32 msm_vidc_get_buffer_region_monaco(struct msm_vidc_inst *inst,
...
static const struct msm_vidc_platform_data monaco_data = {
	.core_data = core_data_monaco,
	.core_data_size = ARRAY_SIZE(core_data_monaco),
	.instance_data = instance_data_monaco,
	.instance_data_size = ARRAY_SIZE(instance_data_monaco),
...
static struct msm_vidc_platform_ops monaco_platform_ops = {
	.buffer_region = msm_vidc_get_buffer_region_monaco,
};
...
static int msm_vidc_init_data(struct msm_vidc_core *core)
{
	...
	d_vpr_h("%s: initialize monaco data\n", __func__);

	core->platform->data = monaco_data;
	core->platform_ops = &monaco_platform_ops;

	return rc;
}

int msm_vidc_init_platform_monaco(struct msm_vidc_core *core, struct device *dev)
{
	int rc = 0;
...
int msm_vidc_deinit_platform_monaco(struct msm_vidc_core *core, struct device *dev)
{
	/* do nothing */
	return 0;
}
