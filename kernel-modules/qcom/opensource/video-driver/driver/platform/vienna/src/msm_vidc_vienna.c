...
static struct msm_platform_core_capability core_data_vienna[] = {
	/* {type, value} */
...
static struct msm_platform_inst_capability instance_data_vienna[] = {
	/* {cap, domain, codec,
...
static u32 msm_vidc_get_buffer_region_vienna(struct msm_vidc_inst *inst,
...
static const struct msm_vidc_platform_data vienna_data = {
	.core_data = core_data_vienna,
	.core_data_size = ARRAY_SIZE(core_data_vienna),
	.instance_data = instance_data_vienna,
	.instance_data_size = ARRAY_SIZE(instance_data_vienna),
...
static struct msm_vidc_platform_ops vienna_platform_ops = {
	.buffer_region = msm_vidc_get_buffer_region_vienna,
};
static int msm_vidc_init_data(struct msm_vidc_core *core)
{
	...
	d_vpr_h("%s: initialize vienna data\n", __func__);

	core->platform->data = vienna_data;
	core->platform_ops = &vienna_platform_ops;
