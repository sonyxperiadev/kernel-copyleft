...
static struct msm_platform_core_capability core_data_blair[] = {
	/* {type, value} */
	{ENC_CODECS, H264|HEVC|HEIC},
	{DEC_CODECS, H264|HEVC|VP9|HEIC},
#ifdef CONFIG_ARCH_PITTI
	{MAX_SESSION_COUNT, 8},
#else
...
static struct msm_platform_inst_capability instance_data_blair[] = {
	/* {cap, domain, codec,
...
static const struct msm_vidc_platform_data blair_data = {
	.core_data = core_data_blair,
	.core_data_size = ARRAY_SIZE(core_data_blair),
	.instance_data = instance_data_blair,
	.instance_data_size = ARRAY_SIZE(instance_data_blair),
...
static struct msm_vidc_platform_ops blair_platform_ops = {
	.buffer_region = msm_vidc_get_buffer_region_blair,
};
static int msm_vidc_init_data(struct msm_vidc_core *core)
{
	...
	d_vpr_h("%s: initialize blair data\n", __func__);

	core->platform->data = blair_data;
	core->platform_ops = &blair_platform_ops;
