...
/*!
  * \file fts_limits.h
  * \brief Contains the size and the byte array of the production test limit
  *file which contains thresholds used to test data
  */
...
const uint32_t myArray2_size = 16725;	/* /< size of the array containing the
					 * production limit file */
