...
DATARMNET1ac13d5a2a(struct DATARMNET8d3c2559ca*DATARMNET7ed5754a5c,struct 
...
DATARMNET2d4b4cfc9e=DATARMNETcc0a01df2a(DATARMNET7ed5754a5c);if(
DATARMNET2d4b4cfc9e){GENL_SET_ERR_MSG(DATARMNET54338da2ff,
...
DATARMNET7ed5754a5c.DATARMNET57656f6f2f=NULL;strscpy(DATARMNET2d4b4cfc9e->
...
);return-ESRCH;}if(DATARMNETaba2beb199(DATARMNET2d4b4cfc9e->DATARMNET852d4d00e2,
...
DATARMNETe8608dd267){hash_del_rcu(&DATARMNET63b1a086d5->DATARMNETe8608dd267);
kfree_rcu(DATARMNET63b1a086d5,DATARMNET28bfe9e6ad);}mutex_unlock(&
DATARMNET954bef55d0);}rx_handler_result_t DATARMNET37a92021f9(struct sk_buff**
DATARMNET89946cec52){struct DATARMNET0ca9d8ead7 DATARMNETa76763310b={};struct 
DATARMNETb89ecedefc DATARMNET3396919a68={};struct DATARMNET41b426061d*
...
if(!DATARMNET00dcb79bc4||DATARMNETaba2beb199(DATARMNET00dcb79bc4->name,
DATARMNET30500ba48c,IFNAMSIZ))return NOTIFY_DONE;if(!DATARMNETaba2beb199(
DATARMNET00dcb79bc4->name,"\x72\x6d\x6e\x65\x74\x5f\x64\x61\x74\x61",
(0xd27+224-0xdfd))){pr_info(
"" "\n"
,__func__);return NOTIFY_DONE;}switch(DATARMNET7f045a1e6e){case 
NETDEV_UNREGISTER:netdev_rx_handler_unregister(DATARMNET00dcb79bc4);break;case 
NETDEV_REGISTER:if(netdev_rx_handler_register(DATARMNET00dcb79bc4,
DATARMNET37a92021f9,NULL))pr_err(
...
DATARMNET268a8314cf;}static int DATARMNET56777c5470(void){DATARMNET755f0f0df8[
(0xd2d+202-0xdf7)]=(0xd2d+202-0xdf7);return(0xd2d+202-0xdf7);}static void 
DATARMNETbb4efa5b3d(void){DATARMNET116f9a46aa();DATARMNET56777c5470();
DATARMNET1f36d4813c();DATARMNET8c0e010dfb();DATARMNETe5b03fe375();
DATARMNETad43e44c7e();DATARMNET56fde5181e();}static int DATARMNET38ebe8f319(
struct sk_buff*DATARMNET543491eb0f,int DATARMNET1faf88208b){if(!pskb_may_pull(
...
);return DATARMNET268a8314cf;}strscpy(DATARMNET30500ba48c,DATARMNET852d4d00e2,
...
genl_info*DATARMNET54338da2ff){int DATARMNET268a8314cf;if(!DATARMNETaba2beb199(
...
DATARMNET268a8314cf){GENL_SET_ERR_MSG(DATARMNET54338da2ff,
"\x4b\x65\x72\x6e\x65\x6c\x20\x65\x72\x72\x6f\x72\x2c\x20\x6e\x6f\x74\x69\x66\x69\x65\x72\x20\x75\x6e\x72\x65\x67\x69\x73\x74\x65\x72\x20\x66\x61\x69\x6c\x65\x64"
);return DATARMNET268a8314cf;}strscpy(DATARMNET755f0f0df8,DATARMNET852d4d00e2,
IFNAMSIZ);return DATARMNET268a8314cf;}int DATARMNETa903cd5994(char*
DATARMNET852d4d00e2,struct genl_info*DATARMNET54338da2ff){return 
DATARMNET116f9a46aa();}int DATARMNET9d7bb9a63d(char*DATARMNET852d4d00e2,struct 
genl_info*DATARMNET54338da2ff){return DATARMNET56777c5470();}int 
...
DATARMNET4c1c11d8a5(struct DATARMNETe117226f58*DATARMNET3396919a68){int 
DATARMNET268a8314cf;mutex_lock(&DATARMNET38726379d1);DATARMNET268a8314cf=
DATARMNET51f60f2fd3(DATARMNET3396919a68);mutex_unlock(&DATARMNET38726379d1);
return DATARMNET268a8314cf;}int DATARMNET56fde5181e(void){int 
DATARMNET268a8314cf;mutex_lock(&DATARMNET38726379d1);DATARMNET268a8314cf=
