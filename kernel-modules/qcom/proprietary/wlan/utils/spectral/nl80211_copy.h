 ...
 *	No Acknowledgment Policy should be applied.
 *
 ...
 *	the driver to not wait for an acknowledgment. Note that due to this,
 ...
 *	%NL80211_CMD_CONNECT it contains the behaviour-specific attribute
 *	containing the parameters for BSS selection to be done by driver
 *	and/or firmware.
 *
 ...
 *	multicast packets should be send out as unicast to all stations
 *	(flag attribute).
 *
