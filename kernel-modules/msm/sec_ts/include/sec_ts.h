...
#ifdef CONFIG_TOUCH_DRIVER_SEINE_ADAPATION
#define DEVICE_ID_2	0x61
#else
#define DEVICE_ID_2	0x71
#endif
#define DEVICE_ID_WD_MAX	3

#ifdef CONFIG_TOUCH_DRIVER_EDO_ADAPATION
#define RESET_GPIO	38
#elif defined(CONFIG_TOUCH_DRIVER_SEINE_ADAPATION)
#define RESET_GPIO	97
#else
