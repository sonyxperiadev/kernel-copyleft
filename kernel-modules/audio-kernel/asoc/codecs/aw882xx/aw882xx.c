...
static void aw882xx_request_firmware(struct work_struct *work)
{
	...
	static char ACF_BIN_NAME[64] = {0};

	if(is_aw88263)
		strcpy(ACF_BIN_NAME, "aw88263_acf.bin");
	else
		strcpy(ACF_BIN_NAME, "aw88261_acf.bin");
...
static int aw882xx_read_chipid(struct aw882xx *aw882xx)
{
	...
	while (cnt < AW_READ_CHIPID_RETRIES) {
		...
		case PID_2032_ID: {
			...
			aw882xx->aw_pa->chip_id = reg_value;
			get_hardware_info_data(HWID_SMARTPA,"AW88263");
			is_aw88263 = true;
			return 0;
		}
		case PID_2055_ID: {
		...
		case PID_2113_ID: {
			...
			aw882xx->aw_pa->chip_id = reg_value;
			get_hardware_info_data(HWID_SMARTPA,"AW88261");
			is_aw88263 = false;
			return 0;
		}
		default:
