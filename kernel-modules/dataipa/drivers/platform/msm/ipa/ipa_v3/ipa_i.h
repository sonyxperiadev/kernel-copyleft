...
struct ipa3_context {
	...
	bool gfp_no_retry;
	/* SONY_BEGIN - (PDX-246V code for JIMODM18-510572 by Wanting.Lei at 2025/05/12 start) */
	u32 ipa_smem_size;
	/* SONY_END - (PDX-246V code for JIMODM18-510572 by Wanting.Lei at 2025/05/12 END) */
};
