...
#define SHORT_DEFAULT_TARGET_CHATTER_INTERVAL	490
#define SHORT_POWER_OFF_RETRY_INTERVAL	490
...
int qn6813v_set_display_brightness(struct mipi_dsi_device *dsi, u16 brightness);
#endif /* _DSI_PANEL_H_ */
