...
DTS_FILES =
	ifeq ($(PRODUCT_NAME),tianchi_dsds)
	$(TOP)/kernel/arch/arm/boot/dts/msm8226-v1-$(SOMC_BOARD).dts \
	$(TOP)/kernel/arch/arm/boot/dts/msm8226-v2-$(SOMC_BOARD).dts
	else ifeq ($(PRODUCT_NAME),tianchi)
	$(TOP)/kernel/arch/arm/boot/dts/msm8926-$(SOMC_BOARD).dts
	endif
else
