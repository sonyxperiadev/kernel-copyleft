...
ifeq "$(USE_SOMC_BOARD)" "y"
# Sync with $(TOP)/kernel/arch/arm/mach-msm/Makefile.boot

	ifeq ($(TARGET_PRODUCT),tianchi_dsds)
	DTS_FILES =$(TOP)/kernel/arch/arm/boot/dts/msm8226-v1-$(SOMC_BOARD).dts \
	           $(TOP)/kernel/arch/arm/boot/dts/msm8226-v2-$(SOMC_BOARD).dts
	else ifeq ($(TARGET_PRODUCT),tianchi)
	DTS_FILES = $(TOP)/kernel/arch/arm/boot/dts/msm8926-v1-$(SOMC_BOARD).dts \
	           $(TOP)/kernel/arch/arm/boot/dts/msm8926-v2-$(SOMC_BOARD).dts
	else ifeq ($(TARGET_PRODUCT),wukong)
	DTS_FILES = $(TOP)/kernel/arch/arm/boot/dts/msm8926-v1-$(SOMC_BOARD).dts \
	           $(TOP)/kernel/arch/arm/boot/dts/msm8926-v2-$(SOMC_BOARD).dts
	endif
